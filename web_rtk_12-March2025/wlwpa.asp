...
<div id="wlan_security_table" style="display:none" class="data_common data_common_notitle">
  ...
  <div class="data_common">
   ...
   <label class="left-field">SSID Type:</label>
   
    <select class="right-field custom-select"  name=wpaSSID onChange="SSIDSelected( this.selectedIndex )">
...
<option value=6>WPA2 Mixed</option>
  ...
  <div id="enable_8021x" style="display:none">
  <div class="col-md-12 form-group">
       <div class="custom-control">
   <label class="left-field">802.1x Authentication:</label>
    <input  class="right-field custom-checkbox" type="checkbox" id="use1x" name="use1x" value="ON" onClick="show_8021x_settings()">
   </div>
   </div>
   </div>
  <div id="show_wep_auth" style="display:none">
    <div class="col-md-12 form-group">
       <div class="custom-control">
   <label class="left-field">Authentication:</label>
  
    <input class="right-field-radio" name="auth_type" type=radio value="open">Open System
    <input class="right-field-radio" name="auth_type" type=radio value="shared">Shared Key
    <input class="right-field-radio" name="auth_type" type=radio value="both">Auto
  </div>
  </div>
  </div>
  ...
  <div class="col-md-12 form-group">
       <div class="custom-control">
   <label class="left-field">Key Length:</label>
   
    <select size="1" name="length0" id="key_length"  class="right-field custom-select" onChange="updateWepFormat(document.formEncrypt, 0)">
 ...
 <div class="col-md-12 form-group">
       <div class="custom-control">
   <label class="left-field">Key Format:</label>
    <select class="right-field custom-select" id="key_format" name="format0" onChange="setDefaultKeyValue(document.formEncrypt, 0)">
  ...
  <div class="col-md-12 form-group">
       <div class="custom-control">
    <label class="left-field">Encryption Key:</label>
    <input  class="right-field custom-select" type="password" id="key" name="key0" maxlength="26" size="26" value="">
    <img id="showkey_0" onclick="showkey0Clicked()" src="graphics/visible.png" style="width:15px; height:12px">
   </div>
   </div>

 </div>
 <div id="setting_wpa" style="display:none">
  <div id="show_wpaAuth">
   <div class="col-md-12 form-group">
       <div class="custom-control">
   <label class="left-field">Authentication Mode:</label>
  
    <input  class="right-field-radio" name="wpaAuth" type="radio" value="eap" onClick="show_wpa_settings()">Enterprise (RADIUS)
    <input  class="right-field-radio" name="wpaAuth" type="radio" value="psk" onClick="show_wpa_settings()">Personal (Pre-Shared Key)
  </div>
  </div>
  <div id="show_dotIEEE80211W" style="display:none">
   <div class="col-md-12 form-group">
       <div class="custom-control">
   <label class="left-field">IEEE 802.11w:</label>
    <input class="right-field-radio" name="dotIEEE80211W" type="radio" value="0" onClick="show_sha256_settings()">None
    <input class="right-field-radio" name="dotIEEE80211W" type="radio" value="1" onClick="show_sha256_settings()">Capable
    <input class="right-field-radio" name="dotIEEE80211W" type="radio" value="2" onClick="show_sha256_settings()">Required
  ...
  <div id="show_wpa_cipher" style="display:none">
  <div class="col-md-12 form-group">
       <div class="custom-control">
   <label class="left-field">WPA Cipher Suite:</label>
  <input type="checkbox" class="right-field custom-checkbox" name="ciphersuite_t" value=1>TKIP&nbsp;
  <input type="checkbox" class="right-field custom-checkbox" name="ciphersuite_a" value=1>AES
   </div>
  </div>
  </div>
  <div id="show_wpa2_cipher" style="display:none">
  <div class="col-md-12 form-group">
       <div class="custom-control">
   <label class="left-field">WPA2 Cipher Suite:</label>
  
    <input type="checkbox" class="right-field custom-checkbox" name="wpa2ciphersuite_t" value=1>TKIP&nbsp;
    <input type="checkbox" class="right-field custom-checkbox" name="wpa2ciphersuite_a" value=1>AES
  ...
  <div id="show_wpa_gk_rekey" style="display:none">
  <div class="col-md-12 form-group">
       <div class="custom-control">
   <label class="left-field">Group Key Update Timer:</label>
   <input  class="right-field custom-select"  type="text" name="gk_rekey" size="32" maxlength="10" value="">
   
  </div>
  </div>
  </div>
  <div id="show_wpa_psk1" style="display:none">
  <div class="col-md-12 form-group">
       <div class="custom-control">
   <label class="left-field">Pre-Shared Key Format:</label>
    <select class="right-field custom-select" id="psk_fmt" name="pskFormat" onChange="">
  ...
  <div id="show_wpa_psk2" style="display:none">
  <div class="col-md-12 form-group">
  <div class="custom-control">

   <label class="left-field">Pre-Shared Key:</label>
   
    <input class="right-field custom-select" type="password" name="pskValue" id="wpapsk" size="32" maxlength="64" value="">
