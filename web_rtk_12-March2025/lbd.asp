...
<div class="intro_main ">
 <p class="intro_title"><% multilang("2965" "LANG_LOOP_DETECTION"); %></p>
...
<div class="column clearfix">
 <div class="column_title">
  ...
  <p><% multilang("2965" "LANG_LOOP_DETECTION"); %> <% multilang("238" "LANG_CONFIGURATION"); %></p>
...
<div class="column clearfix">
 <div class="column_title">
  <div class="column_title_left"></div>
  <p><% multilang("2965" "LANG_LOOP_DETECTION"); %><% multilang("2979" "LANG_LOOP_DETECTION_STATUS"); %></p>
  <div class="column_title_right"></div>
 </div>
</div>
