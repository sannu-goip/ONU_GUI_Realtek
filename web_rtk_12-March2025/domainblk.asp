...
<div class="intro_main ">
 <p class="intro_title"><% multilang("21" "LANG_DOMAIN_BLOCKING"); %> <% multilang("238" "LANG_CONFIGURATION"); %></p>
...
<div class="column clearfix column_title">
 <div class="column_title_left"></div>
  <p><% multilang("21" "LANG_DOMAIN_BLOCKING"); %> <% multilang("238" "LANG_CONFIGURATION"); %></p>
