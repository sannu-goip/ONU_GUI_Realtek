<% SendWebHeadStr();%>
<title>IPv6 ACL <% multilang("238" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
...
<p class="intro_title">IPv6 ACL <% multilang("238" "LANG_CONFIGURATION"); %></p>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width="30%">IPv6 ACL <% multilang("569" "LANG_CAPABILITY"); %>:</th>
   <td>
    <input type="radio" value="0" name="aclcap" <% checkWrite("v6-acl-cap0"); %>><% multilang("247" "LANG_DISABLE"); %>&nbsp;&nbsp;
    <input type="radio" value="1" name="aclcap" <% checkWrite("v6-acl-cap1"); %>><% multilang("248" "LANG_ENABLE"); %>
   </td>
...
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr>
   <th width="30%"><% multilang("389" "LANG_SOURCE"); %> <% multilang("2001" "LANG_TIP_ADDR"); %>:</th>
   <td><input type="text" size="16" name="sip6Start"></td>
  </tr>
  <tr>
   <th width="30%"><% multilang("389" "LANG_SOURCE"); %> <% multilang("474" "LANG_PREFIX_LENGTH"); %>:</th>
