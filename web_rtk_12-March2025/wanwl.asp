<%SendWebHeadStr(); %>
<title><% multilang("1229" "LANG_WIRELESS_WAN"); %></title>
 ...
 with (document.forms[0])
 {
  ...
  if(typeof enable_opt_125 !== 'undefined' &&enable_opt_125.checked)
  {
   ...
   if (checkString(serial_num.value) == 0) {
    alert("<% multilang("2031" "LANG_INVALID_SERIAL_NUMBER"); %>");
    serial_num.focus();
    return false;
   }
  }
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("1229" "LANG_WIRELESS_WAN"); %></p>
 <p class="intro_content"> <% multilang("1230" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_PARAPETERS_FOR_WIRELESS_WAN_OF_YOUR_ROUTER"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 ...
 <!--
  <tr>
   <td>
    <font size=2><b><% multilang("283" "LANG_ENABLE_VLAN"); %>: </b><input type="checkbox" name="vlan" size="2" maxlength="2" value="ON" onClick=vlanClicked()>
   </td>
  </tr>
  <tr>
   <td>
    <font size=2><b><% multilang("286" "LANG_VLAN"); %> ID: </b><input type="text" name="vid" size="10" maxlength="15">
   </td>
   <td><font size=2><b><% multilang("312" "LANG_802_1P_MARK"); %> </b>
...
<div class="btn_ctl">
 ...
 <input class="link_bg" type="submit" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>" name="apply" onClick="return applyCheck(this)">&nbsp; &nbsp; &nbsp; &nbsp;
 <!--<input type="submit" value="<% multilang("308" "LANG_DELETE"); %>" name="delete" onClick="return deleteCheck()"> -->
