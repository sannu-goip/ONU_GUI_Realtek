                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                     ...
                                                                     <SCRIPT language=javascript>
                                                                        VoipInfo.showRegisterState('Breakdown');
...
<div class="modal fade show" id="HERO019" style="display:none;" aria-modal="true"
                                ...
                                <div class="modal-dialog modal-lg" style="">
                                    ...
                                    <div class="modal-content" style="width:125%;">
                                        ...
                                        <div class="modal-body">
                                            <p> This page shows the status of USB device.
                                            </p>
                                            <h5>LAN Port Status</h5>
                                             <div class="data_common">
  <table class="table  table-bordered table-striped">
   <tr><th width="12%" align=center>USB2.0</th>
<td align=center width="12%">Disconnect</td>
</tr>
                                    ...
                                    <div class="modal-content" style="width:125%;">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <h5>LAN Port Status</h5>
                                             <div class="data_common">
  <table class="table  table-bordered table-striped">
   <tr><th class="table-headcol" width="12%" align=center>Name</th>
<th class="table-headcol" width="12%" align=center>Status</th>
<th class="table-headcol" width="12%" align=center>Speed</th>
<th class="table-headcol" width="12%" align=center>Mode</th>
</tr>
<tr>
<td align=center width="12%">LAN1</td>
<td align=center width="12%">Down</td>
<td align=center width="12%">10Mb</td>
<td align=center width="12%">Half</td>
</tr>
<tr>
<td align=center width="12%">LAN2</td>
<td align=center width="12%">Down</td>
<td align=center width="12%">10Mb</td>
<td align=center width="12%">Half</td>
</tr>
...
<div class="col-xl-12 col-md-12 mb-4">
                                <div class="card " style="margin-left:118px">
                                    <div class="card-header">
                                        ...
                                        <span> <b style="font-size:18px;"><span style="vertical-align:middle;">&nbsp;&nbsp;TR069 Report Status </b></span></span>
                                        <hr>
                                        <p>
                                           This page is used to display the status information of TR069
                                        </p>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                <td>Unreported ( DUT is booting )</td>
