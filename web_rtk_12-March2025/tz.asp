...
<div class="adsl clearfix">
 ...
 <input type="submit" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>" name="save" onClick="return saveChanges(document.time,this)">
 <input type="button" value="<% multilang("443" "LANG_REFRESH"); %>" name="refresh" onClick="javascript: window.location.reload()">
