<%SendWebHeadStr(); %>
<title><% multilang("1289" "LANG_BRIDGE_GROUPING"); %><% multilang("238" "LANG_CONFIGURATION"); %></title>
<script>
function btnRemove()
{
...
<div class="intro_main ">
 <p class="intro_title"><% multilang(Bridge Grouping); %> <% multilang("238" "LANG_CONFIGURATION"); %></p>
 <p class="intro_content"> <% multilang("784" "LANG_TO_MANIPULATE_A_MAPPING_GROUP"); %>:<br>
    ...
    <b><% multilang("788" "LANG_NOTE_THAT_THE_SELECTED_INTERFACES_WILL_BE_REMOVED_FROM_THEIR_EXISTING_GROUPS_AND_ADDED_TO_THE_NEW_GROUP"); %></b></p>
</div>
...
<div class="data_vertical data_common_notitle">
  ...
  <table>
     <tr>
        <th><% multilang("789" "LANG_GROUPED_INTERFACES"); %></th>
        <th></th>
        <th><% multilang("790" "LANG_AVAILABLE_INTERFACES"); %></th>
     </tr>
     <tr>
        <td>
