                    ...
                    <div class="scoop-content">
                        ...
                        <div class="">
                             ...
                             <div class="scoop-inner-content">
								...
								<div class="white_box">
									<h1 class="heading_grey"><img src="/Dashboard/images/firewall.png" width="45" height="40" class="img_sub" alt=""/><% multilang("1292" "LANG_FIREWALL"); %> <% multilang("248" "LANG_ENABLE"); %></h1>
									<div class="container-fluid">
									<hr class="margin_adjs" />	

  <div class="col-md-12 form-group left-field">
        <div class="custom-control">
 <p><% multilang("2955" "LANG_THIS_PAGE_LET_USER_TO_CONFIG_FIREWALL_LEVEL"); %></p>
</div>
</div>
...
<div class="data_common data_common_notitle">
    <div class="col-md-12 form-group">
        <div class="custom-control custom-radio">
            <label class="left-field"><% multilang("1292" "LANG_FIREWALL"); %>:</label>
            <input type="radio" name="fw_enable" value="1" onClick="show_firewalllevel()" class="right-field-radio"> <% multilang("248" "LANG_ENABLE"); %>
            <input type="radio" name="fw_enable" value="0" onClick="hide_firewalllevel()" class="right-field-radio"> <% multilang("247" "LANG_DISABLE"); %>
        </div>
    </div>
