...
#show6rdSetting table td input[type="text"]{
   margin-left:400px;
    width:170px; 
  ...
  <p class="left-field-para"><% multilang("1156" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_WHICH_WAN_TO_USE_OF_YOUR_ROUTER"); %></p>
   ...
   <div class="data_common data_common_notitle">
    <div class="col-md-12 form-group">
        ...
        <input class="right-field-radio" type="radio" name=wanmode value=0><% multilang("1283" "LANG_GPON_WAN"); %>&nbsp;&nbsp
...
<form action=/boaform/admin/formNatType method=post name="formNatType">
  ...
  <div class="col-md-12 form-group">
     ...
     <label class="left-field" >NAT Type:</label>
      <input class="right-field-radio"   name="nattype" type=radio value="NAT1">NAT1&nbsp;&nbsp
