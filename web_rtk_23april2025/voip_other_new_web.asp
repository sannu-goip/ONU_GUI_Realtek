...
<title>Voice other configuration </title>
...
.radio_class label.left-field input[type="radio"] + input[type="radio"] {
    margin-left: 20px; /* space between Disable and Enable options */
}
.sip_radio_buttons label.left-field {
    display: inline-block;
    margin-right: 15px; /* space between label and options */
}

.sip_radio_buttons input[type="radio"] {
    margin-right: 3px; /* space between radio and text (Disable/Enable) */
}
...
input[name="sip_option_flag"] {
    margin-left: 163px; /* only first radio button gets margin */
}
...
<div class="data_common">
    <div class="col-md-12 form-group" id="pulse">
        <div class="custom-control radio_class" >
            <label class="left-field-radio"><%voip_other_get("pulse_dial_detection");%></label>
            </div>
        </div>
...
<div class="form-footer text-right">
 <input class="btn orange_btn" type="submit" value="<% multilang("334" "LANG_APPLY");%>" onclick="return check_other()">
</div>
...
<!-- Networking Configuration -->
 ...
 <div class="col-md-12 form-group left-field">
        <div class="custom-control">
   <h2 class="sub_heading " style="color:#fd7e14; width:250px"><% multilang("2946" "LANG_VOIP_NETWORK_CONFIG"); %></h2>
    </div>
    </div>
     <div class="col-md-12 form-group">
        <div class="custom-control">
    <p class="left-field"><% multilang("2947" "LANG_THIS_PAGE_SHOWS_THE_VOIP_NETWORK_CONFIG"); %></p>
   </div>
   </div>
  <form method="post" action="/boaform/voip_other_set" name=net_form>
  ...
  <div class="column">
   ...
   <div class="col-md-12 form-group left-field">
        <div class="custom-control">
   <h6 class="sub_heading " style="color:#fd7e14; width:250px"><% multilang("1099" "LANG_DSCP_FLAG"); %></h6>
    </div>
   </div>
 <div class="data_common">
    <div class="col-md-12 form-group">
        <div class="custom-control">
            <label class="left-field"><% multilang("1100", "LANG_SIP_DSCP"); %>:</label>
            <input type="text" name="sipDscp" size="5" maxlength="2" value="<%voip_net_get("sipDscp"); %>" class="right-field"> ( 0~63 )
        </div>
    </div>
    <div class="col-md-12 form-group">
        <div class="custom-control">
            <label class="left-field"><% multilang("1101", "LANG_RTP_DSCP"); %>:</label>
            <input type="text" name="rtpDscp" size="5" maxlength="2" value="<%voip_net_get("rtpDscp"); %>" class="right-field"> ( 0~63 )
        </div>
    </div>
</div>
  </div>
  ...
  <div class="form-footer text-right">
   <input class="btn orange_btn" type="submit" value="<% multilang("334" "LANG_APPLY"); %>" onclick="return check_network()">
  </div>
  </div>
  <!--
       &nbsp;&nbsp;&nbsp;&nbsp;
