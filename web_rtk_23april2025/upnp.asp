...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   ...
   <td>
    <input type="radio" value="0" name="daemon"  onClick="proxySelection()"><% multilang("247" "LANG_DISABLE"); %>&nbsp;&nbsp;
    <input type="radio" value="1" name="daemon" onClick="proxySelection()"><% multilang("248" "LANG_ENABLE"); %>
   </td>
  </tr>
