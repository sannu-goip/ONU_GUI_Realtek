...
#eth th {
    padding-right: 20px; /* Add space to the right of <th> */
...
#eth td {
    padding-left: 10px; /* Add space to the left of <td> */
    vertical-align: middle; /* Align vertically in the middle */
}
.container-fluid {
    width: 100%;
...
.link_bg:hover, .orange_btn:hover {
...
h2.sub_heading[style*="color:#fd7e14"] {
    color: #fd7e14;
    border-bottom: none;
}

/* Radio buttons and checkboxes specific spacing */
...
#show6rdSetting table td {
    padding-left: 8px; 
    vertical-align: middle; 
}
#show6rdSetting table td input{
...
#npt table td input[type="checkbox"]{
   margin-left:182px;
    width:170px; 
    padding:2px;   /* Adjust the value as needed */

}
#connectionType table  tr th {
   margin-left:-10px;
    width:365px;
}
#connectionType table td input[type="select"] {
   margin-left:400px;
    width:33px; 
    padding:2px

}
#showPPPIPSettings table  tr th {
   margin-left:-10px;
    width:365px;
    font-weight: 300;
}

#showPPPIPSettings table td input[type="text"]{
   margin-left:168px;
    width:226px; 
    padding:2px;   /* Adjust the value as needed */

}
#showPPPIPSettings table td input[type="password"]{
   margin-left:168px;
    width: 228px; 
    padding:2px;   /* Adjust the value as needed */
...
#showPPPIPSettings table td input[type="radio"]{
   margin-left:126px;
    width:100px; 
    padding:2px;   /* Adjust the value as needed */

}
#showPPPIPSettings table td input[type="checkbox"]{
   margin-left:128px;
    width:100px; 
    padding:2px;   /* Adjust the value as needed */

}
#showPPPIPSettings table td select{
   margin-left:169px;
    width:224px; 
    padding:2px;   /* Adjust the value as needed */

}
#eth table td input[type="checkbox"] {
   margin-left:-132px;
    width:170px; 
    padding:2px;   /* Adjust the value as needed */

}
#eth table td input[type="text"] {
...
#eth td select {
    width: 200px !important; /* Adjust the width for select dropdowns */
    margin-left: -40px; /* Add margin to the left */ 
}

#eth td input[type="checkbox"] {
    width: 200px;
    margin-left: -129px;
}

#IPv6DnsDiv th, #IPv6DnsDiv td {
    font-size: 13px;
    font-weight: normal;
}
table th, table td {
                    ...
                    <div class="scoop-content">
                        ...
                        <div class="">
                          ...
                          <div class="scoop-inner-content">
								...
								<div class="white_box">
									<h1 class="heading_grey"><img src="/Dashboard/images/parental.png" width="45" height="40" class="img_sub" alt=""/><% multilang("11" "LANG_WAN"); %> <% multilang("134" "LANG_MODE"); %></h1>
									<div class="container-fluid">
									<hr class="margin_adjs" />	
								
										<div class="col-md-12 form-group">
											<div class="custom-control">
  <p class="left-field-para"><% multilang("1156" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_WHICH_WAN_TO_USE_OF_YOUR_ROUTER"); %></p>
 </div>
 </div>
   ...
   <div class="data_common data_common_notitle">
    <div class="col-md-12 form-group">
        <div class="custom-control">
        <label class="left-field"><% multilang("281" "LANG_WAN_MODE"); %>:</label>
        <input class="right-field-radio" style="
    margin-left: 178px;
" type="radio" name=wanmode value=0><% multilang("1283" "LANG_GPON_WAN"); %>&nbsp;&nbsp
       <input class="right-field-radio"  type="radio" name=wanmode value=1><% multilang("1284" "LANG_EPON_WAN"); %>&nbsp;&nbsp
       <input class="right-field-radio"  type="radio" name=wanmode value=2><% multilang("12" "LANG_ETHERNET_WAN"); %>
     </div>
     </div>
   </div>
 ...
 <div class="col-md-12 form-group left-field" style="margin-top:-20px;">
        <div class="custom-control">
  <h2 class="sub_heading " style="color:#fd7e14; width:421px"><% getWanIfDisplay(); %> <% multilang("11" "LANG_WAN"); %></h2>
  </div>
  </div>
   <div class="col-md-12 form-group left-field">
        <div class="custom-control">
  <p class="left-field-para"> <% multilang("280" "LANG_PAGE_DESC_CONFIGURE_PARAMETERS"); %><% getWanIfDisplay(); %><% multilang("11" "LANG_WAN"); %></p>
</div>
</div>
...
<select style="
    margin-left: 25px;
" name="lkname" onChange="on_ctrlupdate()" size="1">
  </select>

 <div class="col-md-12 form-group">
        <div class="custom-control">
  <label class="left-field"><% multilang("291" "LANG_ADMIN_STATUS"); %>:</label>
  <input class="right-field-radio" style=" margin-left: 168px;"
type=radio value=1 name="chEnable"><% multilang("248" "LANG_ENABLE"); %>
   <input class="right-field-radio" type=radio value=0 name="chEnable" checked><% multilang("247" "LANG_DISABLE"); %>
  </div>
  </div>
 <div class="col-md-12 form-group" id="vlan_tr">
        <div class="custom-control">

   <label class="left-field"><% multilang("283" "LANG_ENABLE_VLAN"); %>: </label>
  <input  class="right-field-checkbox" style="margin-left:182px;" type="checkbox" name="vlan" size="2" maxlength="2" value="ON" onClick=vlanClicked()>
  </div>
  </div>
  ...
  <input class="right-field custom-select" style="width: 197px;" type="text" name="vid" size="10" maxlength="15">
  ...
  <label class="left-field"> <% multilang("312" "LANG_802_1P_MARK"); %> </label>
  <select  class="right-field custom-select"  style="WIDTH: 200px" name="vprio">
  ...
  <table id="eth" style="margin-left:19px;">
  <tbody>
 <tr >
...
<div class="col-md-12 form-group">
        <div class="custom-control">
  <label class="left-field" <% checkWrite("IPQoS"); %>>
  <% multilang("326" "LANG_ENABLE_QOS"); %>: </label>
 <input class="right-field-checkbox" style="margin-left:182px;" type="checkbox" name="qosEnabled" size="2" maxlength="2" value="ON" >
  </div>
 </div>
 <tr>
 <% ShowConnectionType(); %>
 ...
 <div class="col-md-12 form-group" id=tbmtu>
  ...
  <input class="right-field custom-select"  type="text" name="mtu" size="10" maxlength="15">
  </div>
  </div>
 <div class="col-md-12 form-group" id=dgwshow style="display:none">
        <div class="custom-control">

  <label class="left-field"><% multilang("290" "LANG_DEFAULT_ROUTE"); %>:</label>

   <input type=radio class="right-field radio"  value=0 name="droute"><% multilang("247" "LANG_DISABLE"); %>
 ...
 <div  id="IpProtocolType">
 <% ShowIpProtocolType(); %>
 </div>
 </tbody>
</table>
</div>
<div id="showPPPIPSettings" >
<% ShowPPPIPSettings(); %>
</div>

<% ShowDefaultGateway("p2p"); %>
<div id="show6rdSetting">
<% Show6rdSetting(); %>
</div>
<div id="showIpv6">
<% ShowIPV6Settings(); %>
...
<div class="col-md-12 form-group left-field">
        <div class="custom-control">
  <h2 class="sub_heading " style="color:#fd7e14; width:421px"> <% multilang("2953" "LANG_NAT_TYPE"); %></h2>
  </div>
  </div>
  <div class="col-md-12 form-group left-field">
        <div class="custom-control">
  <p class="left-field-para"> <% multilang("2954" "LANG_THIS_PAGE_IS_USED_TO_SET_NAT_TYPE"); %></p>
</div>
</div>
<form action=/boaform/admin/formNatType method=post name="formNatType">
  ...
  <div class="col-md-12 form-group">
        <div class="custom-control">
     <label class="left-field" >NAT Type:</label>
      <input class="right-field-radio"  style="
    margin-left: 178px;  name="nattype" type=radio value="NAT1">NAT1&nbsp;&nbsp
      <input class="right-field-radio"  name="nattype" type=radio value="NAT2">NAT2&nbsp;&nbsp
      <input class="right-field-radio"  name="nattype" type=radio value="NAT4">NAT4 (default)
