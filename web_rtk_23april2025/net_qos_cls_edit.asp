...
<script type="text/javascript" src="base64_code.js"></script>
 <script language="javascript" src="/Dashboard/JS/menu.js"></script>
  ...
  <script type="text/javascript" src="/JS/jquery.min.js"></script>
    ...
    <script  type="text/javascript" src="/Dashboard/Modules/leftmenu/js/left_menu.js"></script><TITLE><% multilang("817" "LANG_ADD_QOS_CLASSIFICATION_RULES"); %></TITLE>
<style>
SELECT {width:200px;}
</style>
...
<div class="intro_main ">
 <p class="left-field-para"><% multilang("817" "LANG_ADD_QOS_CLASSIFICATION_RULES"); %></p>
 <p class="left-field-para"> <% multilang("819" "LANG_THIS_PAGE_IS_USED_TO_ADD_A_IP_QOS_CLASSIFICATION_RULE"); %></p>
</div>
...
<div class="column">
 ...
 <div class="custom-control" >
    <label class="left-field"><% multilang("95" "LANG_PROTOCOL"); %>:</label>
     <select  class="right-field custom-select" id="proto" size="1" onChange="onChange_proto();"></select>
    </div>
</div>
<div class="col-md-12 form-group" >
 <div class="custom-control" >
    ...
    <label class="left-field">DSCP:</label>
     ...
     <select class="right-field custom-select"  id="dscp" size="1" onChange="onchange_sel1();"></select>
    </div>
</div>
 ...
 <div class="custom-control" >
    <label class="left-field"><% multilang("389" "LANG_SOURCE"); %> IP: </label>
      ...
      <input class="right-field custom-select" type="text" id="sip" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();">
    </div>
</div>
<div class="col-md-12 form-group" >
    <div class="custom-control" >
    <label class="left-field"><% multilang("662" "LANG_SOURCE_MASK"); %>:</label>
      ...
      <input class="right-field custom-select" type="text" id="smsk" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();">
    </div>
</div>
<div class="col-md-12 form-group" >
    <div class="custom-control" >
    <label class="left-field"><% multilang("390" "LANG_DESTINATION"); %> IP: </label>
      ...
      <input class="right-field custom-select" type="text" id="dip" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();">
    </div>
</div>
<div class="col-md-12 form-group" >
    <div class="custom-control" >
    <label class="left-field"><% multilang("663" "LANG_DESTINATION_MASK"); %>: </label>
      ...
      <input class="right-field custom-select" type="text" id="dmsk" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();">
    </div>
</div>
</div>
  ...
  <div class="col-md-12 form-group" >
    ...
    <label class="left-field"><% multilang("389" "LANG_SOURCE"); %> IP: </label>
      ...
      <input class="right-field custom-select" type="text" id="sip6" size="36" maxlength="39" style="width:200px " onChange="onchange_sel1();">
    </div>
</div>
<div class="col-md-12 form-group" >
    <div class="custom-control" >
    <label class="left-field"><% multilang("804" "LANG_SOURCE_PREFIX_LENGTH"); %>:</label>
      ...
      <input class="right-field custom-select" type="text" id="sip6PrefixLen" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();">
    </div>
</div>
<div class="col-md-12 form-group" >
    <div class="custom-control" >
    <label class="left-field"><% multilang("390" "LANG_DESTINATION"); %> IP: </label>
      ...
      <input class="right-field custom-select" type="text" id="dip6" size="36" maxlength="39" style="width:200px " onChange="onchange_sel1();">
    </div>
</div>
<div class="col-md-12 form-group" >
    <div class="custom-control" >
    <label class="left-field"><% multilang("805" "LANG_DESTINATION_PREFIX_LENGTH"); %>: </label>
      ...
      <input class="right-field custom-select" type="text" id="dip6PrefixLen" size="15" maxlength="15" style="width:200px " onChange="onchange_sel1();">
    </div>
</div>
</div>
<div class="col-md-12 form-group" >
    ...
    <label class="left-field"><% multilang("392" "LANG_SOURCE_PORT"); %>: </label>
     <input class="right-field custom-select" type="text" id="spts" size="5" maxlength="5" style="width:97px" onChange="onchange_sel1();">:
     <input class="right-field custom-select" type="text" id="spte" size="5" maxlength="5" style="width:97px;margin-left:2px;" onChange="onchange_sel1();">
    </div>
</div>
<div class="col-md-12 form-group" >
    <div class="custom-control" >
   <label class="left-field"><% multilang("393" "LANG_DESTINATION_PORT"); %>: </label>
     ...
     <input class="right-field custom-select"  type="text" id="dpts" size="5" maxlength="5" style="width:97px" onChange="onchange_sel1();">:
     <input class="right-field custom-select"  type="text" id="dpte" size="5" maxlength="5" style="width:97px;margin-left:2px;" onChange="onchange_sel1();">
   </div>
   </div>
 </div>
 ...
 <div class="col-md-12 form-group" >
    <div class="custom-control" >
     ...
     <label class="left-field"><% multilang("389" "LANG_SOURCE"); %> MAC:</label>
    <input  class="right-field custom-select"  type="text" id="smac" size="17" maxlength="17" style="width:200px " onChange="onchange_sel1();">
    </div>
</div>
<div class="col-md-12 form-group" >
    <div class="custom-control" >
   <label class="left-field"><% multilang("390" "LANG_DESTINATION"); %> MAC:</label>
    <input class="right-field custom-select" type="text" id="dmac" size="17" maxlength="17" style="width:200px " onChange="onchange_sel1();">
  </div>
  </div>
 </div>
