...
<div class="column">
 ...
 <div class="data_common data_common_notitle" id="ip_proto_base" style="display:none;">
  ...
  <div  class="col-md-12 form-group" id='ip4tbl' style="display:block;">
  <div class="custom-control" >
...
<div  class="col-md-12 form-group">
  ...
  <div class="custom-control" >
    <label class="left-field"><% multilang("392" "LANG_SOURCE_PORT"); %>: </label>
     ...
     <input class="right-field custom-select"  type="text" id="spte" size="5" maxlength="5" style="width:97px;margin-left:5px;" onChange="onchange_sel1();">
    </div>
    </div>
   <div  class="col-md-12 form-group" style="display:none">
  <div class="custom-control" >
    ...
    <td width="70%">
     ...
     <input class="right-field custom-select" type="text" id="dpte" size="5" maxlength="5" style="width:97px;margin-left:5px;" onChange="onchange_sel1();">
    </td>
   </tr>
  </table>
 </div>
 ...
 <div class="col-md-12 form-group" id="ether_type_base" >
 <div class="custom-control" >
