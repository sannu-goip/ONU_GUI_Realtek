	...
	if(vPageMap[3][0] == '1'){
		if(vPageMap[3][1] == '1')
			MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_Wireless, "wlbasic.asp", "");
		 	...
		 	MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_Wireless, "wlbasic1.asp", "");
			...
			MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_Wireless, "multi_ap_setting_general.asp", "");
		
	}
	if(vPageMap[3][1] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_WIFI, "wlbasic.asp", "");
	 if(vPageMap[3][2] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_WIFI5G, "wlbasic1.asp", "");
	 if(vPageMap[3][3] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_Bandsteering, "/cgi-bin/net-bandsteering.asp", "");
	 if(vPageMap[3][4] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_EastMesh, "multi_ap_setting_general.asp", "");
	//voice 
...
if(vPageMap[7][0] == '1'){
	if(vPageMap[7][1] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_APP, "ddns.asp", "");

	else if(vPageMap[7][2] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_APP, "app-natset.asp", "");
	else if(vPageMap[7][3] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_APP, "upnp.asp", "");
	else if(vPageMap[7][4] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_APP, "igmproxy.asp", "");
	else if(vPageMap[7][5] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_APP, "arptable.asp", "");						
	else if(vPageMap[7][6] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_APP, "samba.asp", "");								
	else if(vPageMap[7][7] == '1')
	{
		if(isIpsecSupport == 'Yes')
			MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_APP, "app-ipsecList.asp", "");
	}		
	else if(vPageMap[7][8] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_APP, "app_iptv.asp", "");	
	else if(vPageMap[7][9] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_APP, "app-ftp.asp", "");
	else if(vPageMap[7][10] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_APP, "app-catv.asp", "");
	else if(vPageMap[7][11] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_APP, "app-iptv.asp", "");

}
	if(vPageMap[7][1] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_DDNS, "ddns.asp", "");
	if(vPageMap[7][2] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_NAT, "app-natset.asp", "");
	if(vPageMap[7][3] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_UPNP, "upnp.asp", "");
	if(vPageMap[7][4] == '1')
	{
		if(IsIPv6Support == 'Yes')
			MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_IGMPOrMLD, "igmproxy.asp", "");
		else
			MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_IGMP, "igmproxy.asp", "");
	}
	if(vPageMap[7][5] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_DailyAPP, "arptable.asp", "");
	if(vPageMap[7][6] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_SAMBA, "samba.asp", "");
	if(vPageMap[7][7] == '1')
	{
		if(isIpsecSupport == 'Yes')
	...
	if(vPageMap[7][8] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_SNMP, "app_iptv.asp", "");
	if(vPageMap[7][9] == '1')
	...
	if(vPageMap[7][11] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_IPTV, "app_iptv.asp", "");
...
if(vPageMap[6][0] == '1'){
	...
	if(vPageMap[6][1] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_InternetDiagnose, "ping.asp", "");
	if(vPageMap[6][2] == '1')
