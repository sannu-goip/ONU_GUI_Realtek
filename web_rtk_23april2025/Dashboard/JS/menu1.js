...
if(vPageMap[5][0] == '1'){
	...
	if(vPageMap[5][1] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_Management, "password.asp", "");
		...
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_Management, "reboot.asp", "");
		...
		MenuArray[iCount++] = new MenuNodeConstruction(1, Menu_Management, "syslog.asp", ""); 
	...
	if(vPageMap[5][1] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_UserManagement, "password.asp", "");
	...
	if(vPageMap[5][2] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_DeviceManagement, "reboot.asp", "");
	...
	if(vPageMap[5][3] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(2, Menu_LogManagement, "syslog.asp", "");
