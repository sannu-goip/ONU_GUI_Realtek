...
<INPUT id=Selected_Menu type=hidden 
 ...
 <div class="col-md-12 form-group left-field">
     ...
     <h2 class="sub_heading " style="color:#fd7e14; width:250px">IP QoS <% multilang("238" "LANG_CONFIGURATION"); %></h2>
   </div>
   </div>
    ...
    <div class="col-md-12 form-group">
      ...
      <input class="right-field-radio" type="radio" name=qosen value=0 onClick=qosen_click(); checked><% multilang("247" "LANG_DISABLE"); %></td>
      <input class="right-field-radio" type="radio" name=qosen value=1 onClick=qosen_click();><% multilang("248" "LANG_ENABLE"); %></td>
    </div>
    </div>
 ...
 <div class="col-md-12 form-group left-field">
      ...
      <h2 class="sub_heading " style="color:#fd7e14; width:250px">QoS <% multilang("686" "LANG_QUEUE_CONFIG"); %></h2>
    </div>
    </div>
      ...
      <div class="col-md-12 form-group">
        ...
        <input class ="right-field-radio" type="radio" name="queuepolicy" value="prio" onClick=qpolicy_click();><% multilang("688" "LANG_PRIO"); %></td>
        <input class ="right-field-radio"  type="radio" name="queuepolicy" value="wrr" onClick=qpolicy_click();><% multilang("689" "LANG_WRR"); %></td>
       </div>
     </div>
    ...
    <div class="column">
     <div class="column_title">
      ...
      <div class="col-md-12 form-group left-field">
        <div class="custom-control">
      <h2 class="sub_heading " style="color:#fd7e14; width:259px">QoS Bandwidth Config</h2>
      </div>
      </div>
     ...
     <div class="col-md-12 form-group">
        ...
        <input class="right-field" type="text" name="totalbandwidth" id="totalbandwidth" value="1005">Kb
        </div>
        </div>
        <div class="col-md-12 form-group">
        <div class="custom-control">
        <input class="orange_btn" type="button" class="button" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>" onClick="on_save();">
 ...
 <div class="col-md-12 form-group left-field">
        ...
        <div class="custom-control">
     <h2 class="sub_heading " style="color:#fd7e14; width:259px">QoS <% multilang("41" "LANG_CLASSIFICATION"); %></h2>
    </div>
    </div>
 <div class="col-md-12 form-group">
        <div class="custom-control">
  ...
  <div class="data_common">
   ...
   <div class="col-md-12 form-group">
    ...
    <input  class="orange_btn" type="button" class="button" onClick="location.href='net_qos_cls_edit.asp';" value="<% multilang("221" "LANG_ADD"); %>">
  
    <input class="orange_btn" type="button" class="button" onClick="on_submit();" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>">
...
<div class="col-md-12 form-group left-field">
        <div class="custom-control">
      <h2 class="sub_heading " style="color:#fd7e14; width:259px">IP QoS <% multilang("43" "LANG_TRAFFIC_SHAPING"); %></h2>
   </div>
    </div>
   ...
   <div class="data_common data_common_notitle">
    <div class="col-md-12 form-group">
      ...
      <label class="left-field"><% multilang("694" "LANG_TOTAL_BANDWIDTH_LIMIT"); %>:</label>
       ...
       <input class="right-field" type="text" id="totalbandwidth" value="1005"><% multilang("709" "LANG_KB"); %>
   ...
   <div class="col-md-12 form-group">
    ...
    <table>
     <tr>
      <td><input class="link_bg orange_btn"  type="button" onClick="location.href='net_qos_traffictl_edit.asp';" value="<% multilang("221" "LANG_ADD"); %>"></td>
      <td><input class="link_bg orange_btn" type="button" onClick="on_submit();" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>"></td>
      <td>
       <div id="apply" style="display:none">
        <input class="link_bg orange_btn" type="button" onClick="on_apply_bandwidth();" value="<% multilang("670" "LANG_APPLY_TOTAL_BANDWIDTH_LIMIT"); %>">
       </div>
       <div id="cancel" style="display:none">
        <input class="link_bg orange_btn" type="button" onClick="on_cancel_bandwidth();" value="<% multilang("708" "LANG_CANCEL_TOTAL_BANDWIDTH_LIMIT"); %>">
       </div>
      </td>
     </tr>
    </table>
