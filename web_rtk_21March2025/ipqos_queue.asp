<%SendWebHeadStr(); %>
<title>IP <% multilang("42" "LANG_QOS_QUEUE"); %></title>
<script>
var qDesclist;
function addClick() {
...
<div class="intro_main ">
 <p class="intro_title">IP <% multilang("42" "LANG_QOS_QUEUE"); %></p>
 <p class="intro_content"> IP <% multilang("42" "LANG_QOS_QUEUE"); %><% multilang("238" "LANG_CONFIGURATION"); %></p>
</div>
<form action=/boaform/admin/formQueueAdd method=POST name=qos>
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("679" "LANG_QUEUE_CONFIG_LIST"); %></p>
...
<div class="btn_ctl">
 ...
 <input class="link_bg" type='button' onClick='addClick()' value='<% multilang("221" "LANG_ADD"); %>'>
 <!--
...
<div id="queueadd" style="display:none">
 <div class="data_common data_common_notitle">
  <table id=body_header>
   <tr>
    <th><% multilang("680" "LANG_QUEUE_DESCRIPTION"); %>&nbsp;:</th>
    <td><input type="text" name="queuedesc" size="16" maxlength="30" readonly>
    </td>
   </tr>
   <tr>
    <th><% multilang("681" "LANG_QUEUE_STATUS"); %>&nbsp;:</th>
    <td>
     <select name='queueenbl' size="1">
      <option value="0">(<% multilang("682" "LANG_CLICK_TO_SELECT"); %>)
      <option value="1"> <% multilang("247" "LANG_DISABLE"); %>
      <option value="2"> <% multilang("248" "LANG_ENABLE"); %>
     </select>
    </td>
   </tr>
   <tr>
    <th><% multilang("683" "LANG_QUEUE_INTERFACE"); %>&nbsp;:</th>
   ...
   <tr>
    <th><% multilang("684" "LANG_QUEUE_PRIORITY"); %>&nbsp;:</th>
    <td>
 ...
 <div class="btn_ctl">
  <input class="link_bg" type='submit' onClick='return btnApply(this)' value='<% multilang("334" "LANG_APPLY"); %>' name="save">
  <input class="link_bg" type='button' onClick='return btnCancel()' value='<% multilang("685" "LANG_CANCEL"); %>'>
 </div>
</div>
