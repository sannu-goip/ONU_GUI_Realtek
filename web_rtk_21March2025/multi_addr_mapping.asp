...
<div class="intro_main ">
 <p class="intro_title"><% multilang("643" "LANG_ADDRESS_MAPPING_RULE"); %> <% multilang("238" "LANG_CONFIGURATION"); %></p>
 <p class="intro_content"> <% multilang("644" "LANG_THIS_PAGE_IS_USED_TO_SET_AND_CONFIGURE_THE_ADDRESS_MAPPING_RULE_FOR_YOUR_DEVICE"); %> <% multilang("645" "LANG_THE_MAXIMUM_NUMBER_OF_ENTRIES_ARE_16"); %></p>
</div>
<form action=/boaform/formAddressMap method=POST name="addressMap">
<div class="data_common data_common_notitle">
 <table>
   <tr>
       <th><% multilang("293" "LANG_TYPE"); %>:</th>
       <td>
        <select size="1" name="addressMapType" onChange="checkState()">
         <option value=1><% multilang("646" "LANG_ONE_TO_ONE"); %></option>
         <option value=2><% multilang("647" "LANG_MANY_TO_ONE"); %></option>
         <option value=3><% multilang("648" "LANG_MANY_TO_MANY_OVERLOAD"); %></option>
         <option value=4><% multilang("649" "LANG_ONE_TO_MANY"); %></option>
        </select>
       </td>
   </tr>
   <tr>
       <th><% multilang("650" "LANG_LOCAL_START_IP"); %>:</th>
       <td><input type="text" name="lsip" size="15" maxlength="15" value=<% getInfo("local-s-ip"); %>></td>
   </tr>
   <tr>
       <th><% multilang("651" "LANG_LOCAL_END_IP"); %>:</th>
       <td><input type="text" name="leip" size="15" maxlength="15" value=<% getInfo("local-e-ip"); %>></td>
   </tr>
   <tr>
       <th><% multilang("652" "LANG_GLOBAL_START_IP"); %>:</th>
       <td><input type="text" name="gsip" size="15" maxlength="15" value=<% getInfo("global-s-ip"); %>></td>
   </tr>
   <tr>
       <th><% multilang("653" "LANG_GLOBAL_END_IP"); %>:</th>
...
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("654" "LANG_CURRENT_ADDRESS_MAPPING_TABLE"); %></p>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("224" "LANG_DELETE_SELECTED"); %>" name="deleteSelAddressMap" onClick="return deleteClick(this)">&nbsp;&nbsp;
 <input class="link_bg" type="submit" value="<% multilang("225" "LANG_DELETE_ALL"); %>" name="deleteAllAddressMap" onClick="return deleteAllClick(this)">&nbsp;&nbsp;&nbsp;
 <input type="hidden" value="/multi_addr_mapping.asp" name="submit-url">
 <input type="hidden" name="postSecurityFlag" value="">
</div>
<script>
