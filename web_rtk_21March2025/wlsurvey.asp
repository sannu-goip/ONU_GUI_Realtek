            ...
            <div class="scoop-main-container">
                <div class="scoop-wrapper">
                  ...
                  <div class="container-fluid">
                                    <hr class="margin_adjs" style="margin-left:-30px; margin-right:-30px"/>
									<div class="row">
										    <div class="col-md-12 form-group left-field-para">
            <div class="custom-control">

 <p>This page provides tool to scan the wireless network. If any Access Point or IBSS is found, you could choose to connect it manually when client mode is enabled</p>
 </div>
</div>
...
<div class="col-md-12 form-group">
  <div class="custom-control">
  <table class="table table-bordered table-striped"  style="background-color: #f8f9fa; margin-left:-14px; width:371%">
   <tr style="text-align:center;"><th>SSID</th>
<th>BSSID</th>
<th>Channel</th>
<th>Type</th>
<th>Encryption</th>
...
<div class="btn_ctl form-footer">
 <input type="submit" value="Refresh" name="refresh" onClick="return on_submit(this)" class="link_bg btn orange_btn" style="margin-right:-1153px;"">&nbsp;&nbsp;
