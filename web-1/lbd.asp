    ...
    <div class="col-md-12 form-group">
        <div class="custom-control">
            <label class="left-field">EtherType:</label>
              0x<input type="text" class="lbd right-field" name="ether_type" size="13" maxlength="4">
            </div>
        </div>
...
<div class="col-md-12 form-group left-field">
        <div class="custom-control">
 <table id="port_status" class="table table-bordered table-striped" style="background-color: #f8f9fa; width:301%">
  <tr>
   <th>Lan Port</th>
   <th>Status</th>
  </tr>
