...
<div class="intro_main ">
 ...
 <p class="intro_content"> <% multilang("719" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_PARAMETERS_FOR_GRE"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width=30%>GRE:</td>
   <td>
    <input type="radio" name="greEn" value="1" <% checkWrite("gre-on-1"); %> ><% multilang("178" "LANG_ENABLED"); %>&nbsp;&nbsp;
    <input type="radio" name="greEn" value="0" <% checkWrite("gre-on-0"); %> ><% multilang("179" "LANG_DISABLED"); %>
   </td>
   <td><input class="inner_btn" type="submit" value=<% multilang("150" "LANG_APPLY_CHANGES"); %> name="greSet" onClick="return on_submit(this)"></td>
  </tr>
 </table>
</div>
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr>
   <th width=30%><% multilang("291" "LANG_ADMIN_STATUS"); %>:</th>
   <td width=70%>
    <input type="radio" value="1" name="tunnelEn" ><% multilang("248" "LANG_ENABLE"); %>&nbsp;&nbsp;
    <input type="radio" value="0" name="tunnelEn" ><% multilang("247" "LANG_DISABLE"); %>
   </td>
  </tr>
  <tr>
   <th width=30%>Checksum:</th>
   <td width=70%>
    <input type="radio" value="1" name="csumEn" ><% multilang("248" "LANG_ENABLE"); %>&nbsp;&nbsp;
    <input type="radio" value="0" name="csumEn" ><% multilang("247" "LANG_DISABLE"); %>
   </td>
  </tr>
  <tr>
   <th width=30%>Sequencing:</th>
   <td width=70%>
    <input type="radio" value="1" name="seqEn" ><% multilang("248" "LANG_ENABLE"); %>&nbsp;&nbsp;
    <input type="radio" value="0" name="seqEn" ><% multilang("247" "LANG_DISABLE"); %>
   </td>
  </tr>
  <tr>
   <th width=30%>Key:</th>
   <td width=70%>
    <input type="radio" value="1" name="keyEn" ><% multilang("248" "LANG_ENABLE"); %>&nbsp;&nbsp;
    <input type="radio" value="0" name="keyEn" ><% multilang("247" "LANG_DISABLE"); %>
   </td>
  </tr>
  <tr>
  ...
  <tr>
   <th width=30%>802.1Q <% multilang("124" "LANG_VLAN_ID"); %> :</th>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value=<% multilang("221" "LANG_ADD"); %> name="add" onClick="return saveChanges(this)">
 <input class="link_bg" type="submit" value=<% multilang("331" "LANG_MODIFY"); %> name="modify"P onClick="return saveChanges(this)">
 <input class="link_bg" type="submit" value=<% multilang("377" "LANG_REMOVE"); %> name="delgre" onClick="return saveChanges(this)">
 <input type="hidden" value="/gre.asp" name="submit-url">
</div>
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p>GRE <% multilang("414" "LANG__TABLE"); %></p>
