<%SendWebHeadStr(); %>
<META HTTP-EQUIV=Refresh CONTENT="15; URL=l2tp.asp">
...
function addL2TPItf(obj)
{
 ...
 if (document.l2tp.pppconntype.selectedIndex==1)
 {
  ...
  {
   alert('<% multilang("2286" "LANG_PLEASE_SELECT_DEFAULT_GATEWAY_FOR_DIAL_ON_DEMAND"); %>');
...
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr>
   <th><% multilang("343" "LANG_IDLE_TIME_MIN"); %>:</td>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>" name="addL2TP" onClick="return addL2TPItf(this)">&nbsp;&nbsp;</td>
</div>
<div class="column">
