...
if(vPageMap[1][4] == '1')
    if(VoipType == 'H.248')
		MenuArray[iCount++] = new MenuNodeConstruction(2, "����������Ϣ", "/cgi-bin/sta-VoIP248.asp", "");
	else
...
if(vPageMap[2][0] == '1'){
	if(vPageMap[2][1] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(1, "����", "/cgi-bin/qos-dslimit.asp", "");
	else if(vPageMap[2][12] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, "����", "/cgi-bin/nat-onetoone.asp", "");																
        else if(vPageMap[2][13] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, "����", "/cgi-bin/net-l2ogre.asp", "");
}
if(vPageMap[2][1] == '1')
...
if(vPageMap[2][10] == '1')
	MenuArray[iCount++] = new MenuNodeConstruction(2, "QoS��������", "/cgi-bin/qos-dslimit.asp", "");
if(vPageMap[2][12] == '1')
	MenuArray[iCount++] = new MenuNodeConstruction(2, "One-to-One", "/cgi-bin/nat-onetoone.asp", "");
if(vPageMap[2][13] == '1')
	MenuArray[iCount++] = new MenuNodeConstruction(2, "L2oGRE����", "/cgi-bin/net-l2ogre.asp", "");
//Sec->3
if(vPageMap[3][0] == '1'){
	if(vPageMap[3][1] == '1')
	...
	else if(vPageMap[3][9] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, "��ȫ", "/cgi-bin/mac_limit.asp", "");				
}
if(vPageMap[3][1] == '1')
...
if(vPageMap[3][9] == '1')
	MenuArray[iCount++] = new MenuNodeConstruction(2, "MacDup Detect", "/cgi-bin/mac_limit.asp", "");
//App->4
if(vPageMap[4][0] == '1'){
	if(vPageMap[4][1] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(1, "Ӧ��", "/cgi-bin/app-snmp.asp", "");	
}
if(vPageMap[4][1] == '1')
...
if(vPageMap[6][0] == '1'){
	if(vPageMap[6][1] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(1, "���", "/cgi-bin/diag-servicediagnose.asp", "");	
}

if(vPageMap[6][1] == '1')
	MenuArray[iCount++] = new MenuNodeConstruction(2, "�������", "/cgi-bin/diag-quickdiagnose.asp", "");
if(vPageMap[6][2] == '1')
	MenuArray[iCount++] = new MenuNodeConstruction(2, "ҵ�����", "/cgi-bin/diag-servicediagnose.asp", "");
//Help->7
if(vPageMap[7][0] == '1')
