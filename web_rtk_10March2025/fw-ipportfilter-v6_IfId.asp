 ...
 <div class="data_common data_common_notitle" <% checkWrite("rg_hidden_function"); %>>
  <table>
   <tr <% checkWrite("rg_hidden_function"); %>>
    <th><% multilang("381" "LANG_OUTGOING_DEFAULT_ACTION"); %>:&nbsp;&nbsp;</th>
   ...
   <tr>
   <tr <% checkWrite("rg_hidden_function"); %>>
    <th><% multilang("384" "LANG_INCOMING_DEFAULT_ACTION"); %>:&nbsp;&nbsp;</th>
    <td><input type="radio" name="inAct" value=0 <% checkWrite("v6_ipf_in_act0"); %>><% multilang("382" "LANG_DENY"); %>&nbsp;&nbsp;
...
<div class="data_common data_common_notitle">
 ...
 <table>
  <tr>
   <th width="30%"><% multilang("389" "LANG_SOURCE"); %> <% multilang("492" "LANG_INTERFACE_ID"); %>:</th>
