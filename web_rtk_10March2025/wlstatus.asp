...
<script>
 ...
 for(i=0; i < wlan_num; i++){
  document.write(' <div class="column"> <div class="column_title"> <div class="column_title_left"></div><p class="sub_heading " style="color:#fd7e14; width:250px">WLAN Configuration</p><div class="column_title_right"></div> </div> <div class="data_common"> <table>');
  document.write(' <div class="col-md-12 form-group"> <label class="left-field">Mode</label> <td width=60%>' );
  if(wlanMode[i] == 0)
   document.write("AP");
  if(wlanMode[i] == 1){
   if (networkType[0] == 0)
