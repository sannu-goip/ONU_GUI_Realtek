...
<div class="intro_main ">
 ...
 <p class="intro_content"> <% multilang("668" "LANG_ENTRIES_IN_THIS_TABLE_ARE_USED_FOR_TRAFFIC_CONTROL"); %></p>
</div>
...
<div id="traffictl_tbl" class="data_vertical data_common_notitle">
  ...
  <table>
   <tr>
    ...
    <th><% multilang("389" "LANG_SOURCE"); %> Port</th>
    <th><% multilang("390" "LANG_DESTINATION"); %> Port</th>
...
<div class="btn_ctl">
 <input class="link_bg" type="button" onClick="on_Add()" value="<% multilang("221" "LANG_ADD"); %>">
 <input class="link_bg" type="button" onClick="on_submit(this);" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>">
 <input class="link_bg" type="button" onClick="on_apply_bandwidth(this);" value="<% multilang("670" "LANG_APPLY_TOTAL_BANDWIDTH_LIMIT"); %>">
</div>
