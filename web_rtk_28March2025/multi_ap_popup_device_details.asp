<% SendWebHeadStr();%>
<title><% multilang("273" "LANG_WLAN_EASY_MESH_DEVICE_DETAILS"); %></title>
<style>
.on {display:on}
.off {display:none}
</style>
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("273" "LANG_WLAN_EASY_MESH_DEVICE_DETAILS"); %></p>
 <p class="intro_content"><% multilang("274" "LANG_WLAN_EASY_MESH_DEVICE_DETAILS_DESC"); %></p>
</div>
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("275" "LANG_WLAN_EASY_MESH_NEIGHBOR_RSSI"); %>:</p>
...
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("277" "LANG_WLAN_EASY_MESH_STA_INFO"); %>:</p>
  <div class="column_title_right"></div>
</div>
<div class="data_common">
...
<div class="btn_ctl">
  ...
  <input type="button" value="<% multilang("743" "LANG_CLOSE"); %>" class="link_bg" name="close" onClick="javascript: window.close();">
</div>
</form>
</body>
</html>
