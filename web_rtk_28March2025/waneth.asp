  ...
  if ( document.ethwan.adslConnectionMode.selectedIndex != 0 ) {
   if(document.ethwan.IpProtocolType.value & 2)
   {
    ...
    if (<% checkWrite("DSLiteShow"); %>) {
     if (document.ethwan.adslConnectionMode.selectedIndex == 6)
     {
...
<div class="intro_main ">
 ...
 <p class="intro_content"> <% multilang("280" "LANG_PAGE_DESC_CONFIGURE_PARAMETERS"); %><% multilang("12" "LANG_ETHERNET_WAN"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr>
   ...
   <td><input type=radio value=0 name="droute"><% multilang("247" "LANG_DISABLE"); %>
