...
<div class="intro_main ">
 <p class="intro_title"><% multilang("38" "LANG_BRIDGING"); %> <% multilang("238" "LANG_CONFIGURATION"); %></p>
...
<div class="data_common data_common_notitle">
 <table>
   <tr>
       ...
       <td width="70%"><input type="text" name="ageingTime" size="15" maxlength="15" value=<% getInfo("bridge-ageingTime"); %>> (<% multilang("357" "LANG_SECONDS"); %>)</td>
   </tr>
   <tr>
       <th>802.1d <% multilang("448" "LANG_SPANNING_TREE"); %>:</th>
       <td>
        <input type="radio" value="0" name="stp" <% checkWrite("br-stp-0"); %>><% multilang("179" "LANG_DISABLED"); %>&nbsp;&nbsp;
       <input type="radio" value="1" name="stp" <% checkWrite("br-stp-1"); %>><% multilang("178" "LANG_ENABLED"); %>
       </td>
   </tr>
 </table>
</div>
