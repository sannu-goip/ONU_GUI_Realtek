 ...
 <table>
  ...
  <div class="data_common">
       ...
       <div class="custom-control">
        ...
        <input type="text" name="fragThreshold" class="right-field custom-select" size="10" maxlength="4" value=2346>(256-2346)
   </div>
    </div>
     <div class="col-md-12 form-group">
       <div class="custom-control">
        <label  class="left-field">RTS Threshold:</label>
        <input type="text" name="rtsThreshold" class="right-field custom-select" size="10" maxlength="4" value=2347>(0-2347)
    </div>
    </div>
      <div class="col-md-12 form-group">
       <div class="custom-control">
        <label  class="left-field">Beacon Interval:</label>
       <input type="text" class="right-field custom-select" name="beaconInterval" size="10" maxlength="4" value=100> (20-1024 ms)
    </div>
    </div>
    <div class="col-md-12 form-group">
       <div class="custom-control">
        <label  class="left-field">DTIM Period:</label>
        <input type="text" name="dtimPeriod" class="right-field custom-select" size="10" maxlength="4" value=1> (1-255)
    </div>
    </div>
    <div class="col-md-12 form-group">
       <div class="custom-control">
        <label  class="left-field">Data Rate:</label>
        <select size="1" name="txRate" class="right-field custom-select">
    <SCRIPT>
     band=76
txrate=1
auto=1
...
<input type="radio" class="right-field-radio" value="long" name="preamble">Long Preamble&nbsp;&nbsp;
<input type="radio" class="right-field-radio" style="margin-left:125px;"  name="preamble" value="short">Short Preamble
    </div>
    </div>
    <div class="col-md-12 form-group">
        <div class="custom-control">
 <label class="left-field">Broadcast SSID:</label>
<input type="radio" class="right-field-radio" name="hiddenSSID" value="no">Enabled&nbsp;&nbsp;
<input type="radio" class="right-field-radio" name="hiddenSSID" value="yes" onClick="alert('If you disable this, WPS will be disabled!')">Disabled
</div>
</div>
<div class="col-md-12 form-group">
        <div class="custom-control">
<label class="left-field">Relay Blocking:</label>
<input type="radio"  class="right-field-radio" name=block value=1>Enabled&nbsp;&nbsp;
<input type="radio"   class="right-field-radio" name=block value=0>disabled
</div>
</div>
<div class="col-md-12 form-group">
        <div class="custom-control">
...
<input type="radio" class="right-field-radio" name="protection" value="yes">Enabled&nbsp;&nbsp;
<input type="radio" class="right-field-radio" name="protection" value="no">Disabled</div>
</div>
<div class="col-md-12 form-group">
        <div class="custom-control">
<label class="left-field">Aggregation:</label>
<input type="radio" class="right-field-radio" name="aggregation" value="enable">Enabled&nbsp;&nbsp;
<input type="radio" class="right-field-radio" name="aggregation" value="disable">Disabled
</div>
</div>
<div id="ShortGi" style="display:none">
<div class="col-md-12 form-group">
        <div class="custom-control">
...
<div class="col-md-12 form-group">
        <div class="custom-control">
<label class="left-field">TX beamforming:</label>
<input type="radio" class="right-field-radio" name="txbf" value=1 onClick='wltxbfChange()'>Enabled&nbsp;&nbsp;
<input type="radio"  class="right-field-radio" name="txbf" value=0 onClick='wltxbfChange()'>Disabled
</div>
</div>
</div>
<div id="txbf_mu_div"  style="display:none">
<div class="col-md-12 form-group">
        <div class="custom-control">
       <label class="left-field">MU MIMO:</label/>

<input  class="right-field-radio" type="radio" name="txbf_mu" value=1>Enabled&nbsp;&nbsp;
<input class="right-field-radio" type="radio" name="txbf_mu" value=0>Disabled</div>
</div>
</div>
<div class="col-md-12 form-group">
        <div class="custom-control">
...
<input class="right-field custom-select" type="text" name="RssiThHigh" size="10" maxlength="4">-(0-100) dBm
</div>
</div>
</div>
...
<input  class="right-field custom-select" type="text" name="RssiThLow" size="10" maxlength="4">-(0-100) dBm
</div>
 </div>
</div>
<div class="col-md-12 form-group">
    ...
    <input type="radio" class="right-field-radio" name=WmmEnabled value=1>Enabled&nbsp;&nbsp;
    <input type="radio" class="right-field-radio"  name=WmmEnabled value=0>Disabled
    </div>
    </div>
    <div class="col-md-12 form-group">
        <div class="custom-control">
<label class="left-field">802.11k Support:</label>
    <input type="radio" class="right-field-radio" name=dot11kEnabled value=1 onClick='wlDot11kChange()'>Enabled&nbsp;&nbsp;
    <input type="radio" class="right-field-radio" name=dot11kEnabled value=0 onClick='wlDot11kChange()'>Disabled
    </div>
    </div>
    <div id="dot11v"  style="display:none">
    <div class="col-md-12 form-group">
        <div class="custom-control">
    <label class="left-field">802.11v Support:</label>
    <input type="radio" class="right-field-radio" name=dot11vEnabled value=1>Enabled&nbsp;&nbsp;
    <input type="radio" class="right-field-radio" name=dot11vEnabled value=0>Disabled
    </div>
    
    </div>
    </table>

    <hr class="margin_adjs" style="margin-left:-16px;margin-right:-520px;">
  </div>
...
document.advanceSetup.WmmEnabled[0].checked = true;
document.advanceSetup.dot11kEnabled[1].checked = true;
document.advanceSetup.dot11vEnabled[1].checked = true;
