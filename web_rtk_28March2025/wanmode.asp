<% SendWebHeadStr();%>
<title><% multilang("1155" "LANG_WAN_MODE_SELECTION"); %></title>
...
function SubmitWANMode(obj)
{
 ...
 if(confirm("<% multilang("2569" "LANG_IT_NEEDS_REBOOTING_TO_CHANGE_WAN_MODE"); %>"))
 {
  obj.isclick = 1;
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("281" "LANG_WAN_MODE"); %></p>
