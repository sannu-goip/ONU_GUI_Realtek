...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th colspan=2>
    <input type="checkbox" name="wlanDisabled" value="OFF"
    ONCLICK=updateState(document.wlanSetup)>&nbsp;&nbsp;Disable WLAN Interface
   </th>
  </tr>
  <tr>
   <th width="26%">Band:</th>
...
<option value=75>5 GHz (A+N+AC)</option>
  ...
  <tr>
   ...
   <td width="74%"><select size="1" name="mode" onChange="updateMode()">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="button" value="Multiple AP" name="multipleAP" onClick="showMultipleAP(document.wlanSetup, '/admin/wlmultipleap.asp')" class="inner_btn">
   </td>
  </tr>
  <tr>
   <th width="26%">SSID:</th>
   <td width="74%"><input type=text name=ssid size="25" maxlength="32" value="FTTH-84E8-5G">
   </td>
  </tr>
 </table>
...
<option value="4">15%</option>
  ...
  <tr>
   ...
   onClick="showMacClick('/boaform/admin/formWirelessTbl?submit-url=/admin/wlstatbl.asp&wlan_idx=0')" class="inner_btn">
   </td>
  </tr>
  <tr id="repeater_check" style="display:none">
   <th colspan=2>
    <input type="checkbox" name="repeaterEnabled" value="ON" 
