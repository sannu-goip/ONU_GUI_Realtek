...
<form action=/boaform/form2WebWizard4 method=POST name="WebWizard4">
 ...
 <div class="adsl clearfix btn_center">
  ...
  <input class="link_bg" type="button" value="Next" onClick="return onClickContinue(0);">
 </div>
 </div>
 ...
 <div class="data_common data_common_notitle">
  <table>
   ...
   <tr>
    <th colspan="2">
        <div>
            <p>Select port to connect STB</p>
            <div>
                <p>
 ...
 <div class="adsl clearfix btn_center">
  <input class="link_bg" type="button" name="back" value="Back" onClick="window.location.href='web_wizard_1.asp';">
  <input class="link_bg" type="button" value="Next" onClick="return onClickContinue(1);">
 </div>
 </div>
 ...
 <div class="adsl clearfix btn_center">
  <input class="link_bg" type="button" name="back" value="Back" onClick="window.location.href='web_wizard_1.asp';">
  <input class="link_bg" type="button" value="Next" onClick="return onClickContinue(2);">
