...
<body>
<INPUT id=Selected_Menu type=hidden value="Tr069->Tr069" name=TR069>
    ...
    <div class="col-md-12 form-group">
        <div class="custom-control">
            <label class="left-field">Enable CWMP WAN ACL:</label>
                ...
                <input class="right-field-radio" type="submit" value="Apply Changes" name="applyACL" onclick="return on_submit(this)" style="width:40px">
            </div>
        </div>
...
<hr style="margin-left: -30px;width: 96%;">
    <div class="col-md-12 form-group">
        <div class="custom-control">
 <input class="left-field" type="submit" value="Add" name="addIP" onClick="return addClick(this)">
</div>
</div>
<hr style="margin-left: -30px;width: 96%;">
...
<hr style="margin-left: -30px;width: 96%;">
 ...
 <div class="col-md-12 form-group">
        <div class="custom-control"> 
      <input class="left-field" type="submit" value="Delete Selected" name="delIP" onClick="return deleteClick(this)">&nbsp;&nbsp;
      <input type="hidden" value="/tr069config_stun.asp" name="submit-url">
      <input type="hidden" name="postSecurityFlag" value="">
</div>
</div>
