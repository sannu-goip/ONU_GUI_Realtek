...
<div class="intro_main ">
 ...
 <% multilang("130" "LANG_WLAN_BASIC_SETTINGS"); %></p>
 <p class="intro_content" style="margin-left:57px;"><% multilang("131" "LANG_PAGE_DESC_WLAN_BASIC_SETTING"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr>
    <th colspan="2">
     <div class="flex-container" style="gap:385px;">
       <span style="font-weight:lighter;"><% multilang("132" "LANG_DISABLE_WLAN_INTERFACE"); %></span>
       <input class="custom-checkbox" type="checkbox" name="wlanDisabled" value=<% wlanStatus(); %>ONCLICK="updateState(document.wlanSetup)">
     </div>
    </th>
   </tr>
  ...
  <tr>
   <th class="width" style="font-weight:lighter"><% multilang("133" "LANG_BAND"); %>:</th>
...
<% checkWrite("wlband"); %>
  ...
  <tr>
   <th class="width"  style="font-weight:lighter"><% multilang("134" "LANG_MODE"); %>:</th>
   <td><select class="height-select-inputs custom-select w-400" size="1" name="mode" onChange="updateMode()">
    <% checkWrite("wlmode"); %>

    </select>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input style="width:100px" class="btn orange_border_btn" type="<% checkWrite("display_multi_ap") %>" value="<% multilang("154" "LANG_MULTIPLE_AP"); %>" name="multipleAP" onClick="showMultipleAP(document.wlanSetup, '/admin/wlmultipleap.asp')" class="inner_btn height-select-inputs">
   </td>
  </tr>
  <tr>
   <th  style="font-weight:lighter" width="26%"><% multilang("135" "LANG_SSID"); %>:</th>
   <td width="74%"><input class="height-select-inputs custom-select w-400" type=text name=ssid size="25" maxlength="32" value="<% getInfo("ssid"); %>">
   </td>
  </tr>
 </table>
 <div id="optionfor11n" style="display:none">
  <table>
   <tr>
    <th  style="font-weight:lighter" class="width"><% multilang("136" "LANG_CHANNEL_WIDTH"); %>:</th>
   ...
   <tr <% checkWrite("wlan_qtn_hidden_function"); %>  >
    <th  style="font-weight:lighter" width="26%"><% multilang("144" "LANG_CONTROL_SIDEBAND"); %>:</th>
 ...
 <table>
  <tr>
   <th width="26%"  style="font-weight:lighter"><% multilang("145" "LANG_CHANNEL_NUMBER"); %>:</th>
  ...
  <tr <% checkWrite("wlan_qtn_hidden_function"); %> >
   <th width="26%"  style="font-weight:lighter"><% multilang("151" "LANG_RADIO_POWER"); %>:</th>
  ...
  <tr id="wl_limit_stanum" style="display:none">
   <th width="26%"  style="font-weight:lighter"><% multilang("147" "LANG_STA_NUMBER"); %>:</th>
   <td>
  ...
  <tr>
   <th width="26%" style="font-weight:lighter"><% multilang("148" "LANG_ASSOCIATED_CLIENTS"); %>:</th>
  ...
  <tr id="repeater_check" style="display:none">
    <th colspan=2>
     <div  style="gap:106px;" class="flex-container">
       <span  style="font-weight:lighter"> <% multilang("2988" "LANG_WLAN_REPEATER_MODE"); %></span>
       <input class="custom-checkbox"  type="checkbox" name="repeaterEnabled" value="ON" <% checkWrite("repeaterEnabled"); %>ONCLICK="updateRepeaterState(document.wlanSetup)">&nbsp;&nbsp; 
     </div>
    </th>
 </tr>
...
<div class="btn_ctl form-footer">
 ...
 <input style="width:122px;"type="submit" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>"
