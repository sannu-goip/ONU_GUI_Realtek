...
<div style="
    ...
    align-items: center;
    gap: 5px;
"><img src="/img/wi-fi.png" style="width:38px;"><p class="intro_title"><% multilang("130" "LANG_WLAN_BASIC_SETTINGS"); %></p></div>
...
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr>
   ...
   <td width="74%"><select size="1" name="mode" onChange="updateMode()">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="<% checkWrite("display_multi_ap") %>" value="<% multilang("154" "LANG_MULTIPLE_AP"); %>" name="multipleAP" onClick="showMultipleAP(document.wlanSetup, '/wlmultipleap.asp')" class="inner_btn">
   </td>
  </tr>
  <tr>
 ...
 <table>
  ...
  <tr>
   ...
   onClick="showMacClick('/boaform/formWirelessTbl?submit-url=/wlstatbl.asp&wlan_idx=<% checkWrite("wlan_idx"); %>')" class="inner_btn">
   </td>
  </tr>
