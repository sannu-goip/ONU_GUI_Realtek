 ...
 <table>
  <tr>
   ...
   <td width ="75%">
                ...
                Hour<input type="text" name="hour" value="18" size="2" maxlength="2">
                Min<input type="text" name="minute" value="44" size="2" maxlength="2">
                Sec<input type="text" name="second" value="32" size="2" maxlength="2">
         </td>
  </tr>
