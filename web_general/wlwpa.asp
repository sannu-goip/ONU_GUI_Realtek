...
<div style="
    ...
    align-items: center;
    gap: 5px;
"><img src="/img/wi-fi.png" style="width:38px;"><p class="intro_title"><% multilang("199" "LANG_WLAN_SECURITY_SETTINGS"); %></p></div>
