...
<script type="text/javascript" src="base64_code.js"></script>
 <script language="javascript" src="/Dashboard/JS/menu.js"></script>
  ...
  <script type="text/javascript" src="/JS/jquery.min.js"></script>
    ...
    <script  type="text/javascript" src="/Dashboard/Modules/leftmenu/js/left_menu.js"></script><title>ALG <% multilang("615" "LANG_ON_OFF"); %><% multilang("238" "LANG_CONFIGURATION"); %></title>
<style>
...
#algtype table td input[type="radio"]{
     margin-left:750px;
    width:740px; 
    padding:2px;   
}
                    ...
                    <div class="scoop-content">
                        ...
                        <div class="">
                          ...
                          <div class="scoop-inner-content">
								...
								<div class="white_box">
									<h1 class="heading_grey"><img src="/Dashboard/images/parental.png" width="45" height="40" class="img_sub" alt=""/>ALG <% multilang("615" "LANG_ON_OFF"); %> <% multilang("238" "LANG_CONFIGURATION"); %></h1>
									<div class="container-fluid">
									<hr class="margin_adjs" />	
								
										<div class="col-md-12 form-group">
											<div class="custom-control">
  <p class="left-field-para"><% multilang("616" "LANG_THIS_PAGE_IS_USED_TO_ENABLE_DISABLE_ALG_SERVICES"); %></p>
 </div>
 </div>
...
<form action=/boaform/formALGOnOff method=POST name=algof>
 <div class="column_title column">
  ...
  <div class="col-md-12 form-group left-field">
        <div class="custom-control">
         <h2 class="sub_heading " style="color:#fd7e14; width:421px">ALG <% multilang("293" "LANG_TYPE"); %></h2>
  </div>
 </div>
 ...
 <div class="data_common data_vertical">
  <table  id="algtype" class="table table-bordered table-striped">
...
<div class="col-md-12 form-group left-field">
        <div class="custom-control">
         <h2 class="sub_heading " style="color:#fd7e14; width:421px">DMZ <% multilang("238" "LANG_CONFIGURATION"); %></h2>
  </div>
 </div>
 <div class="col-md-12 form-group">
        <div class="custom-control">
        <p class="left-field-para"><% multilang("420" "LANG_A_DEMILITARIZED_ZONE_IS_USED_TO_PROVIDE_INTERNET_SERVICES_WITHOUT_SACRIFICING_UNAUTHORIZED_ACCESS_TO_ITS_LOCAL_PRIVATE_NETWORK_TYPICALLY_THE_DMZ_HOST_CONTAINS_DEVICES_ACCESSIBLE_TO_INTERNET_TRAFFIC_SUCH_AS_WEB_HTTP_SERVERS_FTP_SERVERS_SMTP_E_MAIL_SERVERS_AND_DNS_SERVERS"); %></p>
       </div>
      </div>
   ...
   <div class="custom-control">
    ...
    <label class="left-field"><% multilang("421" "LANG_DMZ_HOST"); %>:</label>
       
     <input class="right-field-radio" type="radio" value="0" name="dmzcap" <% checkWrite("dmz-cap0"); %> onClick="updateState()"><% multilang("247" "LANG_DISABLE"); %>&nbsp;&nbsp;
     <input class="right-field-radio" type="radio" value="1" name="dmzcap" <% checkWrite("dmz-cap1"); %> onClick="updateState()"><% multilang("248" "LANG_ENABLE"); %>&nbsp;&nbsp;
      </div>
      </div>
   <div class="col-md-12 form-group">
       <div class="custom-control">

     <label class="left-field"><% multilang("421" "LANG_DMZ_HOST"); %> <% multilang("89" "LANG_IP_ADDRESS"); %>: </label>
     <input class="right-field custom-select" style="margin-left:176px" type="text" name="ip" size="15" maxlength="15" value=<% getInfo("dmzHost"); %> 
   </div>
   </div>
   </div>
   <hr class="margin_adjs" />
   <div class="btn_ctl form-footer">
    <input class="link_bg btn orange_btn" type="submit" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>" name="save" onClick="return saveClick(this)">
...
<div class="col-md-12 form-group left-field">
        <div class="custom-control">
         <h2 class="sub_heading " style="color:#fd7e14; width:421px"><% multilang("20" "LANG_PORT_FORWARDING"); %></h2>
  </div>
  </div>
  <div class="col-md-12 form-group">
  <div class="custom-control">
  <p class="left-field-para"><% multilang("396" "LANG_PAGE_DESC_NAT_FIREWALL_FILTER_TABLE"); %></p>
 </div>
 </div>
   ...
   <div class="col-md-12 form-group">
   <div class="custom-control">
    <label class="left-field"> <% multilang("20" "LANG_PORT_FORWARDING"); %>:</label>
       <input class="right-field-radio" type="radio" value="0" name="portFwcap" <% checkWrite("portFw-cap0"); %> onClick="updateState1()"><% multilang("247" "LANG_DISABLE"); %>&nbsp;&nbsp;
       <input class="right-field-radio" type="radio" value="1" name="portFwcap" <% checkWrite("portFw-cap1"); %> onClick="updateState1()"><% multilang("248" "LANG_ENABLE"); %>&nbsp;&nbsp;
    
     
       <input class="right-field btn orange_btn" style="
    margin-left: 31px;
    width: 116px;"  type="submit" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>" name="apply" onClick="return on_submit1(this)">&nbsp;&nbsp;
   ...
   <div class="data_common data_common_notitle">
     <div class="col-md-12 form-group">
       ...
       <input style="margin-left:-319px;" type="checkbox" name="fw_enable" value="1" checked>
       <label class="right-field " ><% multilang("404" "LANG_APPLICATION"); %></label>
   ...
   <table class="table table-bordered table-striped" style="background-color: #f8f9fa; margin-left:25px; width:94%;">
    ...
    <hr class="margin_adjs">
   <div class="btn_ctl form-footer">
    <input class="link_bg btn orange_btn" type="submit" value="<% multilang("221" "LANG_ADD"); %>" name="addPortFw" onClick="return addClick(this)">
   
    <input type="hidden" value="/app-natset.asp" name="submit-url">
    <% showPFWAdvForm(); %>
   </div>
   <input type="hidden" name="postSecurityFlag" value="">
   <script> updateState1(); </script>
   </form>
   ...
   <div class="column">
    <div class="column_title">
     ...
     <div class="col-md-12 form-group left-field">
        <div class="custom-control">
         <h2 class="sub_heading " style="color:#fd7e14; width:421px"><% multilang("402" "LANG_CURRENT_PORT_FORWARDING_TABLE"); %></h2>
  </div>
  </div>
    ...
    <div class="data_common data_vertical">
    <table  class="table table-bordered table-striped" style="background-color: #f8f9fa; margin-left:25px; width:90%;" >
     <% portFwList(); %>
    </table>
    </div>
   </div>
   <hr class="margin_adjs">
   <div class="btn_ctl form-footer">
    <input class="link_bg btn orange_btn" type="submit" value="<% multilang("224" "LANG_DELETE_SELECTED"); %>" name="deleteSelPortFw" onClick="return deleteClick(this)">
    <input class="link_bg btn orange_btn" type="submit" value="<% multilang("225" "LANG_DELETE_ALL"); %>" name="deleteAllPortFw" onClick="return deleteAllClick(this)">
   </div>
    <script>
