 ...
 <table>
  ...
  <div class="custom-control">
   <label class="left-field">Samba:</label>
    ...
    margin-left: 20px;" type="radio" value="1" name="sambaCap" onClick="changeSambaCap();" <% checkWrite("samba-cap1"); %>><% multilang("248" "LANG_ENABLE"); %>
     </div>
     </div>
  <% checkWrite("smbSecurity"); %>
  <tbody id="conf">
   <tr>
    <th width=40%>NetBIOS <% multilang("701" "LANG_NAME"); %>&nbsp;:</th>
    <td width=60%><input  class="right-field" type="text" name="netBIOSName" maxlength="15"><td>
   </tr>
   <tr>
    <th><% multilang("1158" "LANG_SERVER_STRING"); %>&nbsp;:</th>
    <td width=60%><input  class="right-field " type="text" name="serverString" maxlength="31"></td>
   </tr>
  </tbody>
 </table>
</div>
