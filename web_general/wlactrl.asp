...
<div class="col-md-12 form-group">
    ...
    <input type="text" name="mac" size="15" maxlength="12" class="right-field custom-select">&nbsp;&nbsp;(ex. 00E086710502)
</div>
</div>
</div>
<div class="btn_ctl form-footer">
 <input type="submit" value="Add" name="addFilterMac" onClick="return addClick(this)" class="link_bg btn orange_btn">&nbsp;&nbsp;
 <input type="reset" value="Reset" name="reset" class="link_bg btn orange_btn">&nbsp;&nbsp;&nbsp;
...
<div class="data_common">
    <div class="col-md-12 form-group">
         ...
         <h2 class="sub_heading " style="color:#fd7e14; width:309px">Current Access Control List</h2>
 ...
 <div class="col-md-12 form-group">
        <div class="custom-control"> 
        <table class="table table-bordered table-striped" style="background-color: #f8f9fa; margin-left:-14px; width:91%;text-align:center">
   <tbody><tr><th>Mode</th>
<th>MAC Address</th>
<th>Select</th>
...
<hr class="margin_adjs">
<div class="btn_ctl  form-footer">
 <input type="submit" value="Delete Selected" name="deleteSelFilterMac" onClick="return deleteClick(this)" class="link_bg btn orange_btn">&nbsp;&nbsp;
 <input type="submit" value="Delete All" name="deleteAllFilterMac" onClick="return deleteAllClick(this)" class="link_bg btn orange_btn">&nbsp;&nbsp;&nbsp;
 <input type="hidden" value="/admin/wlactrl.asp" name="submit-url">
 <input type="hidden" name="wlan_idx" value=1>
 <input type="hidden" name="postSecurityFlag" value="">
</div>
