...
<SCRIPT language=JavaScript type=text/javascript>
    ...
    function btnCommit()
    {
        ...
        if (form.FW_UploadFile.value=="") {
            alert("You must select an upgrade file! ");
        }
        else {
            if (((form.upload_type[0].checked) && (string3 >= 0))
                    ...
                    document.getElementById("warn").innerText = "Uploading,please wait... ";
...
<META content="MSHTML 6.00.6000.16809" name=GENERATOR></HEAD>
    <body onload="FinishLoad();if(getElById('ConfigForm') != null)LoadFrame()" onunload="DoUnload()">
        <INPUT id=Selected_Menu type=hidden
              value="Manage->Upgrade" name=Selected_Menu>
                    ...
                    <ul class="scoop-submenu" id="HelpMenu"></ul>
                        ...
                        <div class="scoop-content">
                            <div id="Header"><header class="header_box scoop-header iscollapsed" header-theme="theme2" scoop-header-position="relative"> <div class="sidebar_toggle"><a href="javascript:void(0)"><i class="icon-menu"></i></a></div><span class="gateway_box">Gateway Name:Home Gateway</span><span class="model_box">Gateway Type:NP1257G</span><a onclick="DoLogout()" href="/cgi-bin/login.asp" id="logOut" name="logOut" target="_top" class="Power_btn"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="25" viewBox="0 0 22 25"> <path id="power_icon" data-name="power_icon" class="cls-1" d="M15.405,3.524s-1.324-.6-1.324.8A3.166,3.166,0,0,0,15.41,6.65,8.495,8.495,0,0,1,11,22.253,8.495,8.495,0,0,1,6.59,6.65,3.167,3.167,0,0,0,7.919,4.322c0-1.4-1.324-.8-1.324-0.8A11.242,11.242,0,0,0,11,25,11.242,11.242,0,0,0,15.405,3.524ZM11.077,0A1.47,1.47,0,0,0,9.46,1.258V12.325a1.47,1.47,0,0,0,1.618,1.258,1.3,1.3,0,0,0,1.463-1.258V1.258A1.3,1.3,0,0,0,11.077,0Z"></path> </svg></a> </header><div class="breadcrum_box"> <ul><li><a href="#">Net</a></li><li>Binding</li><li class="welcom" valign="bottom" align="middle" width="120">Welcome!</li><li valign="bottom"><a href="N/A" target="_blank"> <img width="28" height="16" border="0" align="center" src="/img/logo.jpg" style="vertical-align:middle;margin:0px 3px"></a></li> </ul><div class="help_icon"> <a href="/cgi-bin/help_content.asp#UPNP Configuration" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38"> <path id="help_Icon" data-name="help_Icon" class="cls-1" d="M18.746,0A19,19,0,1,0,38,18.744,19,19,0,0,0,18.746,0ZM18.69,30.565l-0.1,0a2.766,2.766,0,0,1,.065-5.531l0.094,0A2.766,2.766,0,1,1,18.69,30.565Zm6.8-13.49a12.558,12.558,0,0,1-2.268,2.031l-1.16.8a3.147,3.147,0,0,0-1.165,1.418,2.933,2.933,0,0,0-.18,1.19l0,0.186H16.286l0.013-.375c0.054-1.54.092-2.446,0.73-3.194a18.823,18.823,0,0,1,3.3-2.658,3.485,3.485,0,0,0,.782-0.8,2.816,2.816,0,0,0,.67-1.641,3.2,3.2,0,0,0-.608-1.89,2.531,2.531,0,0,0-2.19-.823,2.389,2.389,0,0,0-2.213,1.023,4.112,4.112,0,0,0-.67,2.21v0.189H11.539l0.008-.2c0.118-2.8,1.116-4.809,2.965-5.984a7.809,7.809,0,0,1,4.295-1.127,9.269,9.269,0,0,1,5.54,1.595A5.531,5.531,0,0,1,26.587,13.8,5.461,5.461,0,0,1,25.487,17.076Z"></path> </svg> </a> </div></div>
                                ...
                                <div class="">
                                    ...
                                    <div class="scoop-inner-content">
                                      ...
                                      <h1 class="heading_big bei pb-3" style="font-weight:bold;">Upgrade Management</h1>                                        

                                        <div class="white_box">
                                            <h1 class="heading_grey"><img src="../img/upgrade.png" width="50" height="50" class="img_sub" alt=""/><span style="vertical-align:middle;">Upgrade</span></h1>
                                            <div class="container-fluid">
                                                <hr class="margin_adjs" />
                                             <FORM ENCTYPE="multipart/form-data" name="ConfigForm" method="post" class="row">
                                             <INPUT TYPE="HIDDEN" NAME="postflag" VALUE="1">
                            <INPUT TYPE="HIDDEN" NAME="HTML_HEADER_TYPE" VALUE="2">
                            <INPUT TYPE="HIDDEN" NAME="firmware_type" VALUE="0">
                                                <div class="col-md-12 form-group">
                                                    <h2 class="sub_heading" style="color:#fd7e14;">Select</h2>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                    <input name="upload_type" type="radio" value="1" class="custom-control-input"  id="customRadioInline1"  CHECKED>

                                                          <label class="custom-control-label" for="customRadioInline1">encromfile.cfg</label>

                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                        <input name="upload_type" type="radio" value="4" class="custom-control-input"  id="customRadioInline2">

                                                          <label class="custom-control-label" for="customRadioInline2">tclinux.bin</label>
                                                ...
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <INPUT TYPE="FILE" NAME="FW_UploadFile" SIZE="30" MAXLENGTH="128 class="custom-file-input"  id="customFile">
                                                    </div>

                                                <div class="col-md-12 form-group"><p class="light_grey_text">File Path[Maximum of characters is 128]:</p></div>
                                                <div class="col-md-4 form-group">
                                                <INPUT TYPE="TEXT" NAME="uiStatus"  ID="warn" style="min-width: 400px; min-hight: 32px; background-color:transparent !important;" MAXLENGTH="55" VALUE="" class="InputText InputTextWarning form-control" disabled="disabled">
                            ...
                            if(up.UpgradeStatus == "NONE")
                                         ...
                                         {
                                           document.getElementById("warn").value="Upgrade failed, ont cannot be upgraded to a lower version!";
                                          }                                     
                                   </script>
                                                </div>
                                                <div class="col-md-12 form-group"><p class="light_grey_text" style="color: red;">Note:the upgrade process may take a few minutes,please don't turn off the power during the upgrade. When finished, the device will restart automatically. </p></div>

                                          </FORM>
                                          <div class="col-md-4">
                                            <input class="btn btn-orang" type="button" value="ROMFILE BACKUP" onClick='backup_settings()'>
                                        </div>
            <br/>
                                                <hr class="margin_adjs" />
                                                <div class="form-footer text-right">
                                                <button class="btn btn-orang btn-lg" type="button" id="btnOK" onclick="btnCommit()">Ok</button>
                                                <button class="btn btn-secondary btn-lg" type="button" id="btnCancel" onclick="ContentPage()">Return to Homepage</button>
