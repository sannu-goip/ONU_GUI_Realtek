...
function checkTextStr(obj)
{
 if(obj.value.length > 30){
  alert('<% multilang("2288" "LANG_LENGTH_SHOULD_LESS_THEN_32"); %>');
  obj.focus();
  return false;
 }
 for (var i=0; i<obj.value.length; i++)
 {
  ...
  {
   alert('<% multilang("2289" "LANG_INVALID_CHARACTER_IN_TEXT_AERA"); %>');
   obj.focus();
   return false;
  }
 }
...
function setL2tpServer(obj)
{
 ...
 if (document.l2tp.peeraddr.value=="") {
  alert('<% multilang("2290" "LANG_PLEASE_ENTER_PEER_START_ADDRESS"); %>');
 ...
 if (document.l2tp.localaddr.value=="") {
  alert('<% multilang("2291" "LANG_PLEASE_ENTER_LOCAL_ADDRESS"); %>');
...
function addL2tpAccount(obj)
{
 ...
 if (document.l2tp.s_name.value=="") {
  alert('<% multilang("2292" "LANG_PLEASE_ENTER_L2TP_SERVER_RULE_NAME"); %>');
  document.l2tp.s_name.focus();
  return false;
 }
 if(document.l2tp.s_tunnelAuth.checked){
  if(document.l2tp.s_authKey.value ==""){
   alert('<% multilang("2293" "LANG_PLEASE_ENTER_L2TP_TUNNEL_AUTHKEY"); %>');
 ...
 {
  alert('<% multilang("2294" "LANG_PLEASE_ENTER_L2TP_SERVER_USERNAME"); %>');
 ...
 if (document.l2tp.s_password.value=="") {
  alert('<% multilang("2295" "LANG_PLEASE_ENTER_L2TP_SERVER_PASSWORD"); %>');
...
function addL2tpClient(obj)
{
 ...
 if (document.l2tp.c_name.value=="") {
  alert('<% multilang("2296" "LANG_PLEASE_ENTER_L2TP_CLIENT_RULE_NAME"); %>');
 ...
 if (document.l2tp.mtu.value=="") {
  alert('<% multilang("2297" "LANG_PLEASE_ENTER_L2TP_CLIENT_MTU"); %>');
  ...
  <table>
   ...
   <tr>
    ...
    <td>
     ...
     <input type="radio" value="1" name="tunnelen" checked><% multilang("248" "LANG_ENABLE"); %>
    </td>
   </tr>
   <tr>
    <th>Username:</th>
 ...
 <div class="data_common">
  <table>
   <tr>
    ...
    <th align=center><% multilang("701" "LANG_NAME"); %></th>
    <th align=center><% multilang("248" "LANG_ENABLE"); %></th>
    <th align=center><% multilang("1161" "LANG_USERNAME"); %></th>
 ...
 <div class="data_common">
  <table>
   <tr>
    ...
    <th align=center width="5%"><% multilang("701" "LANG_NAME"); %></th>
    <th align=center width="5%"><% multilang("91" "LANG_SERVER"); %></th>
    <th align=center width="5%"><% multilang("1227" "LANG_TUNNEL_AUTH"); %></th>
    <th align=center width="5%"><% multilang("1228" "LANG_PPP_AUTH"); %></th>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("224" "LANG_DELETE_SELECTED"); %>" name="delSelClient" onClick="return on_submit(this)">&nbsp;&nbsp;
