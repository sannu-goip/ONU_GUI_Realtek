...
<body bgcolor="#ffffff" text="#000000" onload="InitToneConfig()">
 <div class="intro_main ">
  <p class="intro_title"><% multilang("2944" "LANG_VOIP_TONE_CONFIG"); %></p>
  <p class="intro_content"><% multilang("2945" "LANG_THIS_PAGE_SHOWS_THE_VOIP_TONE_CONFIG"); %></p>
 </div>
<form method="post" action="/boaform/voip_tone_set" name=toneform>
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
  <p><% multilang("1041" "LANG_SELECT_COUNTRY"); %></p>
  <div class="column_title_right"></div>
 </div>
 <div class="data_common">
  <table>
   <tr>
    <td bgColor=#aaddff><% multilang("1042" "LANG_COUNTRY"); %></td>
    <td bgColor=#ddeeff>
...
<!--
<b><% multilang("1043" "LANG_SELECT_CUSTOM_TONE"); %></b>
<table cellSpacing=1 cellPadding=2 border=0 width=400>
   <tr>
     <td bgColor=#aaddff width=155><% multilang("1044" "LANG_CUSTOM_TONE"); %></td>
     <td bgColor=#ddeeff width=170>
...
<p>
<b><% multilang("1045" "LANG_TONE_PARAMETERS"); %></b>
<table cellSpacing=1 cellPadding=2 border=0 width=400>
 <tr>
 <td bgColor=#aaddff><% multilang("1046" "LANG_TONETYPE"); %></td>
 <td bgColor=#ddeeff>
 ...
 <tr>
  <td bgColor=#aaddff rowspan=3><% multilang("1047" "LANG_TONECYCLE"); %></td>
 ...
 <tr>
  <td bgColor=#ddeeff><% multilang("1048" "LANG_CYCLE_NO"); %>:
  <input type=text name=cycle size=10 maxlength=5 value="<%voip_tone_get("cycle");%>">
  </td>
 </tr>
 <tr>
  <td bgColor=#ddeeff><font size=1><% multilang("1049" "LANG_0_CYCLE_IS_CONTINUOUS"); %></font>
  </td>
 </tr>
 <tr>
  <td bgColor=#aaddff>CadNum</td>
     <td bgColor=#ddeeff>
  <input type=text name=cadNUM size=10 maxlength=2 value=<%voip_tone_get("cadNUM");%>> <font size=1>(<% multilang("1050" "LANG_1_4_FOR_ADDITIVE_MODULATED_SUCC_SUCC_ADD_1_32_FOR_FOUR_FREQ_2_FOR_STEP_INC_TWO_STEP"); %>)</font></td>
 </tr>
   <tr>
  <td bgColor=#aaddff>CadOn0</td>
     <td bgColor=#ddeeff><input type=text name=CadOn0 size=20 maxlength=9 value="<%voip_tone_get("CadOn0");%>"> <font size=1>(<% multilang("952" "LANG_MSEC");%>)</font></td>
 </tr>
   <tr>
  <td bgColor=#aaddff>CadOff0</td>
     <td bgColor=#ddeeff><input type=text name=CadOff0 size=20 maxlength=9 value="<%voip_tone_get("CadOff0");%>"> <font size=1>(<% multilang("952" "LANG_MSEC");%>)</font></td>
 </tr>
   <tr>
  <td bgColor=#aaddff>CadOn1</td>
     <td bgColor=#ddeeff><input type=text name=CadOn1 size=20 maxlength=9 value="<%voip_tone_get("CadOn1");%>"> <font size=1>(<% multilang("952" "LANG_MSEC");%>)</font></td>
 </tr>
   <tr>
  <td bgColor=#aaddff>CadOff1</td>
     <td bgColor=#ddeeff><input type=text name=CadOff1 size=20 maxlength=9 value="<%voip_tone_get("CadOff1");%>"> <font size=1>(<% multilang("952" "LANG_MSEC");%>)</font></td>
 </tr>
   <tr>
  <td bgColor=#aaddff>CadOn2</td>
     <td bgColor=#ddeeff><input type=text name=CadOn2 size=20 maxlength=9 value="<%voip_tone_get("CadOn2");%>"> <font size=1>(<% multilang("952" "LANG_MSEC");%>)</font></td>
 </tr>
   <tr>
  <td bgColor=#aaddff>CadOff2</td>
     <td bgColor=#ddeeff><input type=text name=CadOff2 size=20 maxlength=9 value="<%voip_tone_get("CadOff2");%>"> <font size=1>(<% multilang("952" "LANG_MSEC");%>)</font></td>
 </tr>
   <tr>
  <td bgColor=#aaddff>CadOn3</td>
     <td bgColor=#ddeeff><input type=text name=CadOn3 size=20 maxlength=9 value="<%voip_tone_get("CadOn3");%>"> <font size=1>(<% multilang("952" "LANG_MSEC");%>)</font></td>
 </tr>
   <tr>
  <td bgColor=#aaddff>CadOff3</td>
     <td bgColor=#ddeeff><input type=text name=CadOff3 size=20 maxlength=9 value="<%voip_tone_get("CadOff3");%>"> <font size=1>(<% multilang("952" "LANG_MSEC");%>)</font></td>
 </tr>
    <tr>
...
<table cellSpacing=1 cellPadding=2 border=0 width=400>
 <tr>
     <td colspan=3 align=center>
      <input type="submit" name="Distone" value="<% multilang("334" "LANG_APPLY"); %>" >
    </td>
 </tr>
</table>
</p>
