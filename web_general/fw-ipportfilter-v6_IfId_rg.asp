...
<style>
  ...
  #ip_portfilter_table th, 
  #ip_portfilter_table td {
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   ...
   <td><input class="inner_btn" type="submit" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>" name="setDefaultAction" onClick="return on_submit(this)">&nbsp;&nbsp;
...
<table>
  ...
  <td>
   ...
   <td><input type="text" size="16" name="sIfId6Start" style=""> </td>
   </tr>
   <tr id="sip6">
   <th><% multilang("389" "LANG_SOURCE"); %> <% multilang("89" "LANG_IP_ADDRESS"); %>:</th>
   <td><input type="text" size="16" name="sip6Start" style="">
   </tr>
   <tr id="sip6prefix">
   <th><% multilang("389" "LANG_SOURCE"); %> <% multilang("474" "LANG_PREFIX_LENGTH"); %>:</th>
   <td><input type="text" size="16" name="sip6PrefixLen" style=""></td>
   </tr>
   <tr>
  ...
  <td>
   ...
   <td><input type="text" size="16" name="dIfId6Start" style=""> </td>
   </tr>
   <tr id="dip6">
   <th><% multilang("390" "LANG_DESTINATION"); %> <% multilang("89" "LANG_IP_ADDRESS"); %>:</th>
   <td><input type="text" size="16" name="dip6Start" style="">
   </tr>
   <tr id="dip6prefix">
   <th><% multilang("390" "LANG_DESTINATION"); %> <% multilang("474" "LANG_PREFIX_LENGTH"); %>:</th>
   <td><input type="text" size="16" name="dip6PrefixLen" style=""></td>
   </tr>
   <tr>
   <th><% multilang("389" "LANG_SOURCE"); %> <% multilang("213" "LANG_PORT"); %>:</th>
   <td><input type="text" size="6" name="sfromPort" style=""> - <input type="text" size="6" name="stoPort" style=""></td>
   </tr>
   <tr>
   <th><% multilang("390" "LANG_DESTINATION"); %> <% multilang("213" "LANG_PORT"); %>:</th>
   <td><input type="text" size="6" name="dfromPort" style=""> - <input type="text" size="6" name="dtoPort" style=""></td>
   </tr>
</table>
</div>
<div class="btn_ctl">
