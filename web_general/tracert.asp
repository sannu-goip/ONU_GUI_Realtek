...
<div style="padding-top:10px;"><p class="intro_title">Traceroute <% multilang("45" "LANG_DIAGNOSTICS"); %></p></div></div>
 <p class="intro_content"><% multilang("500" "LANG_PAGE_DESC_TRACERT_DIAGNOSTIC"); %></p>
</div>
