       ...
       <input class="right-field" type="checkbox" value="ON" name="iapd" id="send2">Request Prefix
               ...
               <div id="DSLiteDiv">
                                       ...
                                       <div class="custom-control" >
                                                                                                  ...
                                                                                                  <input class="right-field" type="checkbox" value="ON" name="dslite_enable" id="dslite_enable" onclick="dsliteSettingChange()" >
                                                                                                  </div>
                                                                                                  </div>
                 <div class="col-md-12 form-group "> 
                                       <div class="custom-control" >
                                                          <label  class="left-field">AFTR Address Mode:</label>
                                                          <select class="right-field" name="dslite_aftr_mode" onchange="dsliteAftrModeChange()" style="width:151px">
			...
			<option value="1">static</option>
                                       ...
                                       <div class="custom-control" >
                                                                                ...
                                                                                <div class="form-group " id="tbl_pmap">
                                                                          
                                                                          <div class="row left-field-checkbox">
                                                                            <div class="col-md-3 ">
...
<br>
                 ...
                 <div class="col-md-12 form-group">
              <div class="custom-control">
                   <h2 class="sub_heading left-field" style="color:#fd7e14;" id="ip_text">NAT Type</h2>
               </div>
               </div>
                          <div class="col-md-6 form-group">
