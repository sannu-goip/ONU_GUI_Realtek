...
<div class="intro_main ">
 <p class="intro_title">QoS Classification</p>
 <p class="intro_content"> This page is used to add or delete classicification rule.<font color="red">(After add a new rule, please click 'Apply Changes' to take effect.)</font></p>
</div>
...
<div class="data_common data_common_notitle">
 <div class="data_common data_vertical">
  <table id="lstrc" >
   <tr>
    <th colspan="2">&nbsp;</th>
    <th colspan="3" align="center">Mark</th>
