...
<body>
  ...
  <h5 class="left-field-para" style="font-weight:300"><% multilang("2939" "LANG_THIS_PAGE_SHOWS_THE_VOIP_GENERAL_CONFIG"); %></h5>
 </div>
 </div>
 <br>
...
<div class="data_common">
    ...
    <div class="col-md-12 form-group">
        <div class="custom-control" style="display:flex">
            ...
            <div id="cpe"><%voip_general_get("Conference_server_cpe");%></div>
        </div>
    </div>
    <div class="col-md-12 form-group">
        <div class="custom-control">
...
<div class="data_common">
    <div class="col-md-12 form-group">
        <div class="custom-control" style="display:flex">
            ...
            <div id="cpe"> <%voip_general_get("CFAll");%></div>
            </div>
        </div>
  ...
  <div class="col-md-12 form-group left-field" >
        <div class="custom-control" id="cfn">
...
<div class="col-md-12 form-group left-field">
        <div class="custom-control">
  <h2 class="sub_heading " style="color:#fd7e14; width:250px; margin-left: -29px;"><%voip_general_get("display_dialplan_title");%></h2>
  </div>
 </div>
 <div class="data_common">
...
<div class="data_common data_common_notitle" id="codec_opt">
        <div  class="table table-bordered table-striped" style="background-color: #f8f9fa; margin-left:25px; width:94%">
...
<div class="column">
  <div class="col-md-12 form-group left-field">
        <div class="custom-control">
<h2 class="sub_heading " style="color:#fd7e14; width:250px; margin-left:-29px"><%voip_general_get("hotline_option_display_title");%></h2>
</div>
</div>
...
<div class="form-footer text-right">
 <input class="btn orange_btn" type="button" value="<% multilang("334" "LANG_APPLY"); %>" onclick="applyclick();">

 <input class="btn grey_btn" type="reset" value="<% multilang("222" "LANG_RESET"); %>">
...
<form method="post" action="/boaform/voip_general_set" name=toneform>
    ...
    <hr style="margin-left: -15px;width: 102.5%;">
            ...
            <div class="form-footer text-right">
     <input class="btn orange_btn" type="submit" name="Country" value="<% multilang("334" "LANG_APPLY"); %>" onclick="on_submit(this);">
     <input type="hidden" name="postSecurityFlag" value="">
</div>
</div>
