<%SendWebHeadStr(); %>
<title><% multilang("704" "LANG_VERSION"); %> </title>
<script>
...
function exportClick()
{
 ...
 alert('<% multilang("1105" "LANG_PAGE_DESC_WAIT_INFO"); %>!');
 return true;
}
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("704" "LANG_VERSION"); %></p>
</div>
...
<DIV align="left" style="padding-left:20px; padding-top:5px">
<div class="intro_main ">
 <p class="intro_title"><% multilang("1104" "LANG_OMCI"); %></p>
</div>
<form action=/boaform/formExportOMCIlog method=POST name="exportOMCIlog">
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width=60%><% multilang("1102" "LANG_EXPORT"); %>:</th>
   <td>
    <input class="inner_btn" type="submit" value="<% multilang("1102" "LANG_EXPORT"); %>" onclick="return exportClick()">
    <input type="hidden" name="postSecurityFlag" value="">
   </td>
  </tr>
 </table>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width=30%><% multilang("1103" "LANG_IMPORT"); %>:</th>
   <td width=30%><input class="inner_btn" type="file" value="<% multilang("546" "LANG_CHOOSE_FILE"); %>" name="binary" size=24></td>
   <td><input class="inner_btn" type="submit" value="<% multilang("1103" "LANG_IMPORT"); %>" name="load" onclick="return uploadClick()"></td>
  </tr>
 </table>
</div>
</form>
