...
<div class="intro_main ">
 ...
 <p class="intro_content"> <% multilang("335" "LANG_PAGE_DESC_ATM_SETTING"); %></p>
</div>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>" name="changeAtmVc" onClick="return addClick(this)">&nbsp;&nbsp;
 <input class="link_bg" type="reset" value="<% multilang("336" "LANG_UNDO"); %>" name="reset" onClick="resetClicked()">
