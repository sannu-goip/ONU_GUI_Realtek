...
function setload()
{
	top.document.getElementById('shade').style.display = 'block';
	top.document.getElementById('loadpagediv').style.display = 'block';
	top.document.getElementById('contentIframe').style.height = '500px';
}
