...
<blockquote>
 <form id="form" action="/boaform/admin/formLoginPassCheck_User" method="post">
  <div align="center">
   <table align="center">
    <tr>
    ...
    <tr>
     ...
     <input type="button" class="link_bg" value="<% multilang("685" "LANG_CANCEL"); %>" onclick="on_submit_cancle();">
