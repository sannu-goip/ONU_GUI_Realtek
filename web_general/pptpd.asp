...
function addPptpAccount(obj)
{
 ...
 if (document.pptp.s_name.value=="") {
  alert("<% multilang("2376" "LANG_PLEASE_ENTER_PPTP_SERVER_RULE_NAME"); %>");
  document.pptp.c_name.focus();
  return false;
 }
 if (document.pptp.s_username.value=="")
 {
  alert("<% multilang("2377" "LANG_PLEASE_ENTER_PPTP_SERVER_USERNAME"); %>");
 ...
 if (document.pptp.s_password.value=="") {
  alert("<% multilang("2378" "LANG_PLEASE_ENTER_PPTP_SERVER_PASSWORD"); %>");
...
function addPptpClient(obj)
{
 ...
 if (document.pptp.c_name.value=="") {
  alert("<% multilang("2379" "LANG_PLEASE_ENTER_PPTP_CLIENT_RULE_NAME"); %>");
  document.pptp.c_name.focus();
  return false;
 }
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("224" "LANG_DELETE_SELECTED"); %>" name="delSelAccount" onClick="return on_submit(this)">&nbsp;&nbsp;
 <input class="link_bg" type="submit" value="<% multilang("863" "LANG_SAVE"); %>" name="saveAccount" onClick="return on_submit(this)">
</div>
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
 ...
 <div class="data_common">
  <table>
   <tr>
    ...
    <th align=center><% multilang("711" "LANG_ACTION"); %></th>
   </tr>
   <% pptpList(); %>
  </table>
 </div>
