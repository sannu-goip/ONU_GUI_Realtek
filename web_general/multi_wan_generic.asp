...
<input class="link_bg" type="submit" value="<% multilang(LANG_APPLY_CHANGES); %>" name="apply" onClick="return applyCheck(this)" <% checkWrite("show_button"); %>>&nbsp; &nbsp; &nbsp; &nbsp;
<input class="link_bg" type="submit" value="<% multilang(LANG_DELETE); %>" name="delete" id="delete" onClick="return deleteCheck(this)" <% checkWrite("show_button"); %>>
