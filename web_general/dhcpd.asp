   ...
   if (document.dhcpd.dhcpdenable[0].checked == true)
    ...
    if (en_dnsopt == 0)
     ...
     html +=
      ...
      '</div>'+
      '<div class="btn_ctl">'+
      '<input type="submit" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>" name="save" onClick="return saveChanges1()" class="link_bg">&nbsp;&nbsp;'+
...
<div style="
    ...
    align-items: center;
    gap: 5px;
"><div><img src="/img/ip_icon.png" style="width:38px;"></div>
<div style="padding-top:12px;"><p class="intro_title"><% multilang("116" "LANG_LAN_INTERFACE_SETTINGS"); %></p></div></div>
...
<div style="
    ...
    gap: 5px;
"><div><img src="/img/ip_icon.png" style="width:38px;"></div>
<div style="padding-top:12px;"><p class="intro_title" style="margin-top: 6px !important;">DHCP <% multilang("375" "LANG_SETTINGS"); %></p></div>
</div>
