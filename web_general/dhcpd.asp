...
#displayDhcpSvr table td b:nth-of-type(2) {
    margin-left: 187px; 
}
#displayDhcpSvr table td input[type="text"] {
    margin-left: 1px; 
      width:173px
}
#dhcpMode{
...
<hr class="margin_adjs">
  <div class="form-footer text-right">
   <input class="btn orange_btn" type="submit" value="<% multilang("150" "LANG_APPLY_CHANGES"); %>" name="save" onClick="return saveChanges()" class="link_bg" style="margin-left: 6px;">
