...
<style>
    ...
    .status_ipv6_table th, .status_ipv6_table td{
        border: 1px solid #ccc;
        text-align: center !important;
    }
    .status_ipv6_table th{
...
<div class="column">
 <div class="column_title">
  <div class="column_title_left" ></div>
   <p class="intro_title1"><% multilang("6" "LANG_LAN"); %> <% multilang("238" "LANG_CONFIGURATION"); %></p>
...
<div class="column" <% checkWrite("show_button"); %>>
 <div class="column_title">
  <div class="column_title_left"></div>
   <p class="intro_title1"><% multilang("105" "LANG_PREFIX_DELEGATION"); %></p>
  <div class="column_title_right"></div>
 </div>
 <div class="data_common">
  <table>
...
<form action=/boaform/admin/formStatus method=POST name="status_ipv6">
 <div class="column">
  <div class="column_title">
   <div class="column_title_left"></div>
    <p class="intro_title1"><% multilang("11" "LANG_WAN"); %> <% multilang("238" "LANG_CONFIGURATION"); %></p>
   <div class="column_title_right"></div>
  </div>
  <div class="data_common data_vertical">
   <table class="status_ipv6_table">
    <% wanip6ConfList(); %>
   </table>
  </div>
 </div>
 <div class="btn_ctl">
  <input type="hidden" value="/status_ipv6.asp" name="submit-url">
