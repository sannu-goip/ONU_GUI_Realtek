...
<div style="
    ...
    align-items: center;
    gap: 5px;
"><div><img src="/img/easymesh.png" style="width:38px;"></div>
<div style="padding-top:12px;"><p class="intro_title"><% multilang("257" "LANG_WLAN_EASY_MESH_INTERFACE_SETUP"); %></p></div></div>
