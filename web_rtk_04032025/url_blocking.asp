...
<div class="intro_main ">
 <p class="intro_title">URL <% multilang("411" "LANG_BLOCKING"); %></p>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width="30%">URL <% multilang("411" "LANG_BLOCKING"); %>:</th>
   <td width="30%">
    <input type="radio" value="0" name="urlcap" <% checkWrite("url-cap0"); %>><% multilang("247" "LANG_DISABLE"); %>&nbsp;&nbsp;
    <input type="radio" value="1" name="urlcap" <% checkWrite("url-cap1"); %>><% multilang("248" "LANG_ENABLE"); %>&nbsp;&nbsp;
   </td>
   <td width="40%">
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width="30%"><% multilang("413" "LANG_FQDN"); %>: <input type="text" name="urlFQDN" size="15" maxlength="125"></th>
   <td width="40%">
...
<div class="column clearfix column_title">
 <div class="column_title_left"></div>
  <p>URL <% multilang("411" "LANG_BLOCKING"); %> <% multilang("1154" "LANG_TABLE_2"); %></p>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width="30%"><% multilang("415" "LANG_KEYWORD"); %>: <input type="text" name="Keywd" size="15" maxlength="18">&nbsp;&nbsp;</th>
   <td width="40%">
...
<div class="column clearfix column_title">
 <div class="column_title_left"></div>
  <p><% multilang("416" "LANG_KEYWORD_FILTERING_TABLE"); %></p>
 <div class="column_title_right"></div>
</div>
<div class="data_common data_vertical">
 <table>
