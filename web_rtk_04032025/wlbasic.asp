...
<div class="intro_main ">
 <p class="intro_title">WLAN Basic Settings</p>
 <p class="intro_content">This page is used to configure the parameters for WLAN clients which may connect to your Access Point. Here you may change wireless encryption settings as well as wireless network parameters.</p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  ...
  <tr>
    <th>
     <div class="flex-container">
       <span>Disable WLAN Interface</span>
       <input type="checkbox" name="wlanDisabled" value="OFF" ONCLICK="updateState(document.wlanSetup)">
     </div>
    </th>
   </tr>
  ...
  <tr>
   <th class="width">Band:</th>
   <td ><select class="height-select-inputs" size=1 name=band onChange="updateChan(); Set_SSIDbyBand(document.wlanSetup);">
...
<option value=10>2.4 GHz (B+G+N)</option>
  ...
  <tr>
   <th class="width">Mode:</th>
   <td><select class="height-select-inputs" size="1" name="mode" onChange="updateMode()">
    <option selected value="0">AP</option>

    </select>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="button" value="Multiple AP" name="multipleAP" onClick="showMultipleAP(document.wlanSetup, '/admin/wlmultipleap.asp')" class="inner_btn height-select-inputs">
   </td>
  </tr>
  <tr>
   <th width="26%">SSID:</th>
   <td width="74%"><input class="height-select-inputs" type=text name=ssid size="25" maxlength="32" value="FTTH-84E8">
   </td>
  </tr>
 </table>
 <div id="optionfor11n" style="display:none">
  <table>
   <tr>
    <th class="width">Channel Width:</th>
    <td><select class="height-select-inputs" size="1" name="chanwid" onChange="updateChan1()">
...
<option value="3">20/40MHZ</option>
   ...
   <tr  >
    <th width="26%">Control Sideband:</th>
    <td width="74%"><select class="height-select-inputs" size="1" name="ctlband" onChange="updateChan_channebound()">
...
<option value="1">Lower</option>
 ...
 <table>
  <tr>
   <th width="26%">Channel Number:</th>
   <td width="74%"><select class="height-select-inputs" size="1" name="chan" onChange="updateChan_selectedIndex()"> </select></td>
   <SCRIPT>
    regDomain=1
defaultChan=0
  ...
  <tr >
   <th width="26%">Radio Power (%):</th>
   <td width="74%"><select class="height-select-inputs" size="1" name="txpower">
...
<option value="4">15%</option>
  ...
  <tr id="wl_limit_stanum" style="display:none">
   <th width="26%">Limit Associated Client Number:</th>
   <td>
  ...
  <tr>
   <th width="26%">Associated Clients:</th>
   <td width="74%"><input class="height-select-inputs" type="button"
  ...
  <tr id="repeater_check" style="display:none">
    <th colspan=2>
     <div class="flex-container">
       <span>Enable Universal Repeater Mode (Acting as AP and client simultaneously)</span>
       <input type="checkbox" name="repeaterEnabled" value="ON" ONCLICK="updateRepeaterState(document.wlanSetup)">
     </div>
    </th>
 </tr>
  ...
  <tr id="wifi_regdomain_demo" style="display:none">
   <th width="26%">Regdomain:</th>
   <td width="74%"><select class="height-select-inputs" size="1" name="regdomain_demo">
