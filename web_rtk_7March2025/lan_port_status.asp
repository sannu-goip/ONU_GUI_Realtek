...
<title><% multilang("100" "LANG_LAN_PORT_STATUS"); %></title>
<script>
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("100" "LANG_LAN_PORT_STATUS"); %></p>
 <p class="intro_content"> <% multilang("101" "LANG_THIS_PAGE_SHOWS_THE_CURRENT_LAN_PORT_STATUS"); %></p>
</div>
<form action=/boaform/admin/formLANPortStatus method=POST name="status3">
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("100" "LANG_LAN_PORT_STATUS"); %></p>
